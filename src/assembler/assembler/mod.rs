...
pub fn assemble_opcode(
    ...
    match mnemonic{
        ...
        Mnemonic::Halt | 
        Mnemonic::Ind | Mnemonic::Indr |
        Mnemonic::Ini | Mnemonic::Inir |
        Mnemonic::Rra |
        Mnemonic::Scf
...
impl Env {
    pub fn assemble_cp(&mut self, arg: &DataAccess)-> Result<Bytes, AssemblerError>{
        ...
        match arg {
            ...
            DataAccess::Expression(ref exp) => {
                ...
                add_byte(&mut bytes, self.resolve_expr_may_fail_in_first_pass(exp)? as _);
            },
            ...
            DataAccess::IndexRegister16WithIndex(ref reg, ref idx) => {
                ...
                add_byte(&mut bytes, 0xbe);
                add_word(&mut bytes, self.resolve_expr_may_fail_in_first_pass(idx)? as _);
            },
    ...
    pub fn assemble_bit(&mut self, arg1: &Expr, arg2: &DataAccess)-> Result<Bytes, AssemblerError>{
        let mut bytes = Bytes::new();
    ...
    pub fn assemble_shift(&mut self, mne: &Mnemonic, target: &DataAccess) -> Result<Bytes, AssemblerError> {
        let mut bytes = Bytes::new();
        ...
        match arg2 {
            ...
            DataAccess::Memory(ref expr) => {
                ...
                if let Register16::Hl = dst {
                    ...
                    add_byte(&mut bytes, (register16_to_code_with_sp(dst) << 4) + 0b01001011);
                    add_word(&mut bytes, val);
                }
            }
