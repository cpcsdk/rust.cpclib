...
- **True-color conversion**: resize an arbitrary photo and dither it into an automatically chosen (or partially pinned) CPC palette (`--dither`, `--resize-filter`, `--colors`)
