...
ld a,l : add #40 : ld l,a : ld a,h : adc #E0 : ld h,a
;*** line 25/72 ***
dec l : dec l : dec l : ld a,(hl) : and c : or #88 :ld (hl),a
dec l : ld (hl),#F0
dec l : ld (hl),#5A
dec l : ld (hl),#85
dec l : ld a,(hl) : and d : ld (hl),a
...
inc l : ld (hl),#70
inc l : ld a,(hl) : and c : or #88 :ld (hl),a
set 5,h
;*** line 29/72 ***
ld a,(hl) : and c : or e :ld (hl),a
dec l : ld (hl),#F8
...
ld a,l : add #40 : ld l,a : ld a,h : adc #E0 : ld h,a
;*** line 57/72 ***
ld a,l : sub 8 : ld l,a : ld a,(hl) : and c : ld (hl),a
dec l : ld (hl),#CC
dec l : ld a,(hl) : and d : ld (hl),a
set 3,h
;*** line 58/72 ***
