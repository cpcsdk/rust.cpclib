...
pub fn matrix_from_list(expr: &ExprResult) -> Result<ExprResult, Box<crate::AssemblerError>> {
    match expr {
        ExprResult::List(l) => {
            let height = l.len();
...
pub fn matrix_col(matrix: &ExprResult, x: usize) -> Result<ExprResult, Box<crate::AssemblerError>> {
    match matrix {
        ExprResult::Matrix { .. } => {
...
pub fn matrix_set_col(
    ...
    x: usize,
    col: &ExprResult
) -> Result<ExprResult, Box<crate::AssemblerError>> {
    match matrix {
...
pub fn matrix_row(matrix: &ExprResult, y: usize) -> Result<ExprResult, Box<crate::AssemblerError>> {
    match matrix {
        ExprResult::Matrix { .. } => {
