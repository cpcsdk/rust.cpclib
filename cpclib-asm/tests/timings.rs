...
fn timing_cases() -> &'static [TimingCase] {
    &[
        TimingCase {
            timing_mnemonic: "ld r,r'",
            asm: "ld b,c"
        },
        TimingCase {
            timing_mnemonic: "ld r,(hl)",
            asm: "ld a,(hl)"
        },
        TimingCase {
            timing_mnemonic: "ld r,(ix+n)",
            asm: "ld l,(ix+0)"
        },
        TimingCase {
            timing_mnemonic: "ld r,n",
            asm: "ld b,0"
        },
        TimingCase {
            timing_mnemonic: "ld (hl),r",
            asm: "ld (hl),e"
        },
        TimingCase {
            timing_mnemonic: "ld (ix+n),r",
            asm: "ld (ix+0),e"
        },
        TimingCase {
            timing_mnemonic: "ld (hl),n",
            asm: "ld (hl),0"
        },
        TimingCase {
            timing_mnemonic: "ld a,(bc)",
            asm: "ld a,(bc)"
        },
        TimingCase {
            timing_mnemonic: "ld a,(de)",
            asm: "ld a,(de)"
        },
        TimingCase {
            timing_mnemonic: "ld a,(nn)",
            asm: "ld a,(0x1234)"
        },
        TimingCase {
            timing_mnemonic: "ld (bc),a",
            asm: "ld (bc),a"
        },
        TimingCase {
            timing_mnemonic: "ld (de),a",
            asm: "ld (de),a"
        },
        TimingCase {
            timing_mnemonic: "ld (nn),a",
            asm: "ld (0x1234),a"
        },
        TimingCase {
            timing_mnemonic: "ld i,a",
            asm: "ld i,a"
        },
        TimingCase {
            timing_mnemonic: "ld r,a",
            asm: "ld r,a"
        },
        TimingCase {
            timing_mnemonic: "ld a,i",
            asm: "ld a,i"
        },
        TimingCase {
            timing_mnemonic: "ld a,r",
            asm: "ld a,r"
        },
        TimingCase {
            timing_mnemonic: "ld rr,nn",
            asm: "ld bc,0x1234"
        },
        TimingCase {
            timing_mnemonic: "ld ix,nn",
            asm: "ld ix,0x1234"
        },
        TimingCase {
            timing_mnemonic: "ld hl,(nn)",
            asm: "ld hl,(0x1234)"
        },
        TimingCase {
            timing_mnemonic: "ld ix,(nn)",
        ...
        TimingCase {
            timing_mnemonic: "ld (nn),hl",
            asm: "ld (0x1234),hl"
        },
        TimingCase {
            timing_mnemonic: "ld (nn),ix",
            asm: "ld (0x1234),ix"
        },
        TimingCase {
            timing_mnemonic: "ld (nn),rr",
            asm: "ld (0x1234),de"
        },
        TimingCase {
            timing_mnemonic: "ld sp,hl",
            asm: "ld sp,hl"
        },
        TimingCase {
            timing_mnemonic: "ld sp,ix",
            asm: "ld sp,ix"
        },
        TimingCase {
            timing_mnemonic: "push qq",
            asm: "push bc"
        },
        TimingCase {
            timing_mnemonic: "push ix",
            asm: "push ix"
        },
        TimingCase {
            timing_mnemonic: "pop qq",
            asm: "pop bc"
        },
        TimingCase {
            timing_mnemonic: "pop ix",
            asm: "pop ix"
        },
        TimingCase {
            timing_mnemonic: "ex de,hl",
            asm: "ex de,hl"
        },
        TimingCase {
            timing_mnemonic: "ex af,af'",
            asm: "ex af,af'"
        },
        TimingCase {
            timing_mnemonic: "exx",
        ...
        TimingCase {
            timing_mnemonic: "ex (sp),hl",
            asm: "ex (sp),hl"
        },
        TimingCase {
            timing_mnemonic: "ex (sp),ix",
            asm: "ex (sp),ix"
        },
        TimingCase {
            timing_mnemonic: "ldi",
        ...
        TimingCase {
            timing_mnemonic: "ldir",
            asm: "ldir"
        },
        TimingCase {
            timing_mnemonic: "lddr",
            asm: "lddr"
        },
        TimingCase {
            timing_mnemonic: "cpi",
        ...
        TimingCase {
            timing_mnemonic: "cpir",
            asm: "cpir"
        },
        TimingCase {
            timing_mnemonic: "cpdr",
            asm: "cpdr"
        },
        TimingCase {
            timing_mnemonic: "add r",
            asm: "add a,c"
        },
        TimingCase {
            timing_mnemonic: "add (hl)",
            asm: "add a,(hl)"
        },
        TimingCase {
            timing_mnemonic: "add (ix+n)",
            asm: "add a,(ix+0)"
        },
        TimingCase {
            timing_mnemonic: "add n",
            asm: "add a,0"
        },
        TimingCase {
            timing_mnemonic: "adc r",
            asm: "adc a,c"
        },
        TimingCase {
            timing_mnemonic: "sub r",
            asm: "sub c"
        },
        TimingCase {
            timing_mnemonic: "sbc r",
            asm: "sbc a,c"
        },
        TimingCase {
            timing_mnemonic: "and r",
            asm: "and c"
        },
        TimingCase {
            timing_mnemonic: "or r",
            asm: "or c"
        },
        TimingCase {
            timing_mnemonic: "xor r",
            asm: "xor c"
        },
        TimingCase {
            timing_mnemonic: "cp  r",
            asm: "cp c"
        },
        TimingCase {
            timing_mnemonic: "inc r",
            asm: "inc c"
        },
        TimingCase {
            timing_mnemonic: "inc (hl)",
            asm: "inc (hl)"
        },
        TimingCase {
            timing_mnemonic: "inc (ix+n)",
            asm: "inc (ix+0)"
        },
        TimingCase {
            timing_mnemonic: "dec r",
            asm: "dec c"
        },
        TimingCase {
            timing_mnemonic: "dec (hl)",
            asm: "dec (hl)"
        },
        TimingCase {
            timing_mnemonic: "dec (ix+n)",
            asm: "dec (ix+0)"
        },
        TimingCase {
            timing_mnemonic: "add hl,rr",
            asm: "add hl,bc"
        },
        TimingCase {
            timing_mnemonic: "add ix,rr",
            asm: "add ix,bc"
        },
        TimingCase {
            timing_mnemonic: "adc hl,rr",
            asm: "adc hl,bc"
        },
        TimingCase {
            timing_mnemonic: "sbc hl,rr",
            asm: "sbc hl,bc"
        },
        TimingCase {
            timing_mnemonic: "inc rr",
            asm: "inc bc"
        },
        TimingCase {
            timing_mnemonic: "inc ix",
            asm: "inc ix"
        },
        TimingCase {
            timing_mnemonic: "dec rr",
            asm: "dec bc"
        },
        TimingCase {
            timing_mnemonic: "dec ix",
            asm: "dec ix"
        },
        TimingCase {
            timing_mnemonic: "daa",
        ...
        TimingCase {
            timing_mnemonic: "im 0",
            asm: "im 0"
        },
        TimingCase {
            timing_mnemonic: "im 1",
            asm: "im 1"
        },
        TimingCase {
            timing_mnemonic: "im 2",
            asm: "im 2"
        },
        TimingCase {
            timing_mnemonic: "rlca",
            asm: "rlca"
        },
        TimingCase {
            timing_mnemonic: "rrca",
            asm: "rrca"
        },
        TimingCase {
            timing_mnemonic: "rla",
        ...
        TimingCase {
            timing_mnemonic: "rlc r",
            asm: "rlc c"
        },
        TimingCase {
            timing_mnemonic: "rlc (hl)",
            asm: "rlc (hl)"
        },
        TimingCase {
            timing_mnemonic: "rlc (ix+n)",
            asm: "rlc (ix+0)"
        },
        TimingCase {
            timing_mnemonic: "rlc (ix+n),r",
            asm: "rlc (ix+0),b"
        },
        TimingCase {
            timing_mnemonic: "rrc r",
            asm: "rrc c"
        },
        TimingCase {
            timing_mnemonic: "rl r",
            asm: "rl c"
        },
        TimingCase {
            timing_mnemonic: "rr r",
            asm: "rr c"
        },
        TimingCase {
            timing_mnemonic: "sla r",
            asm: "sla c"
        },
        TimingCase {
            timing_mnemonic: "sra r",
            asm: "sra c"
        },
        TimingCase {
            timing_mnemonic: "sl1 r",
            asm: "sll c"
        },
        TimingCase {
            timing_mnemonic: "srl r",
            asm: "srl c"
        },
        TimingCase {
            timing_mnemonic: "rld",
        ...
        TimingCase {
            timing_mnemonic: "bit b,r",
            asm: "bit 3,c"
        },
        TimingCase {
            timing_mnemonic: "bit b,(hl)",
            asm: "bit 3,(hl)"
        },
        TimingCase {
            timing_mnemonic: "bit b,(ix+n)",
            asm: "bit 3,(ix+0)"
        },
        TimingCase {
            timing_mnemonic: "res b,r",
            asm: "res 3,c"
        },
        TimingCase {
            timing_mnemonic: "res b,(hl)",
            asm: "res 3,(hl)"
        },
        TimingCase {
            timing_mnemonic: "res b,(ix+n)",
            asm: "res 3,(ix+0)"
        },
        TimingCase {
            timing_mnemonic: "res b,(ix+n),r",
            asm: "res 3,(ix+0),a"
        },
        TimingCase {
            timing_mnemonic: "set b,r",
            asm: "set 3,c"
        },
        TimingCase {
            timing_mnemonic: "set b,(hl)",
            asm: "set 3,(hl)"
        },
        TimingCase {
            timing_mnemonic: "set b,(ix+n)",
            asm: "set 3,(ix+0)"
        },
        TimingCase {
            timing_mnemonic: "set b,(ix+n),r",
            asm: "set 3,(ix+0),a"
        },
        TimingCase {
            timing_mnemonic: "jp nn",
            asm: "jp 0x1234"
        },
        TimingCase {
            timing_mnemonic: "jp ccc,nn",
            asm: "jp nz,0x1234"
        },
        TimingCase {
            timing_mnemonic: "jp hl",
            asm: "jp (hl)"
        },
        TimingCase {
            timing_mnemonic: "jp ix",
            asm: "jp (ix)"
        },
        TimingCase {
            timing_mnemonic: "jr n",
            asm: "jr 0"
        },
        TimingCase {
            timing_mnemonic: "jr cc,nn",
            asm: "jr nz,0"
        },
        TimingCase {
            timing_mnemonic: "djnz n",
            asm: "djnz 0"
        },
        TimingCase {
            timing_mnemonic: "call nn",
            asm: "call 0x1234"
        },
        TimingCase {
            timing_mnemonic: "call ccc,nn",
            asm: "call nz,0x1234"
        },
        TimingCase {
            timing_mnemonic: "rst ttt",
            asm: "rst 0"
        },
        TimingCase {
            timing_mnemonic: "ret",
        ...
        TimingCase {
            timing_mnemonic: "ret ccc",
            asm: "ret nz"
        },
        TimingCase {
            timing_mnemonic: "reti",
            asm: "reti"
        },
        TimingCase {
            timing_mnemonic: "retn",
            asm: "retn"
        },
        TimingCase {
            timing_mnemonic: "in a,(n)",
            asm: "in a,(0)"
        },
        TimingCase {
            timing_mnemonic: "in r,(C)",
            asm: "in b,(c)"
        },
        TimingCase {
            timing_mnemonic: "in 0,(C)",
            asm: "in 0,(c)"
        },
        TimingCase {
            timing_mnemonic: "ini",
        ...
        TimingCase {
            timing_mnemonic: "inir",
            asm: "inir"
        },
        TimingCase {
            timing_mnemonic: "indr",
            asm: "indr"
        },
        TimingCase {
            timing_mnemonic: "out (n),a",
            asm: "out (0),a"
        },
        TimingCase {
            timing_mnemonic: "out (C),r",
            asm: "out (c),b"
        },
        TimingCase {
            timing_mnemonic: "out (C),0",
            asm: "out (c),0"
        },
        TimingCase {
            timing_mnemonic: "outi",
            asm: "outi"
        },
        TimingCase {
            timing_mnemonic: "outd",
            asm: "outd"
        },
        TimingCase {
            timing_mnemonic: "outir",
            asm: "otir"
        },
        TimingCase {
            timing_mnemonic: "outdr",
            asm: "otdr"
        }
    ]
}
...
fn parse_timings_file_collects_high_level_entries() {
    ...
    assert!(
        entries.len() > 100,
        "Expected to parse many timing rows, got {}",
        entries.len()
    );
...
fn timing_cases_cover_all_documented_mnemonics() {
    let entries = parse_timings_file();
    let documented: BTreeSet<_> = entries
        .iter()
