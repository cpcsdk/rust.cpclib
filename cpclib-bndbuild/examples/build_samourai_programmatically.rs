...
fn main() {
    ...
    let rules = Rules::new(vec![
        ...
        Rule::new(
            ...
            &["clean"] as &[&str],
            &[
                Task::new_echo("Delete uneeded files"),
                Task::new_rm("samourai*.sna").set_ignore_errors(true)
            ]
        ),
        Rule::new(
            &["clean"],
        ...
        Rule::new(
            ...
            &["samourai.sna", "samourai.sym"],
            &[Task::new_basm(
                "linking.asm --progress  --snapshot  -l samourai.sym  -o samourai_linked.sna  --lst linking.lst"
            )]
        ),
        Rule::new(
            &["data/font_000.bin"],
            &["data/font.png"],
            &[Task::new_imgconverter(
                "data/font.png --mode 2  --pen0 26 --pen1 0  tile -w 1 -h 8  -o data/font.bin"
            )]
        ),
    ]);
