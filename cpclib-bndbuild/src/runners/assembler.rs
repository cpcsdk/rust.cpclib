...
mod test {
    ...
    #[test]
    fn test_orgams_help_flag_captured() {
        let runner = super::OrgamsRunner::default();
    ...
    #[test]
    fn test_orgams_version_flag_captured() {
        let runner = super::OrgamsRunner::default();
        let obs = CapturingObserver::new();
    ...
    #[test]
    fn test_orgams_invalid_arg_captured() {
        let runner = super::OrgamsRunner::default();
        let obs = CapturingObserver::new();
    ...
    #[test]
    fn test_basm_help_flag_captured() {
        let runner = super::BasmRunner::<CapturingObserver>::default();
    ...
    #[test]
    fn test_basm_version_flag_captured() {
        let runner = super::BasmRunner::<CapturingObserver>::default();
        let obs = Arc::new(CapturingObserver::new());
        let result = runner.inner_run(&["--version"], &obs);
        assert!(result.is_ok(), "version should succeed");
    ...
    #[test]
    fn test_basm_invalid_arg_captured() {
        let runner = super::BasmRunner::<CapturingObserver>::default();
        let obs = Arc::new(CapturingObserver::new());
        let result = runner.inner_run(&["--not-a-valid-flag"], &obs);
        assert!(result.is_err(), "invalid argument should fail");
