...
impl Emulator {
	...
	pub fn new_winape_default() -> Self {
		Self::DirectAccess(
			cpclib_runner::runner::emulator::Emulator::Winape(Default::default()))
	}

	pub fn new_ace_default() -> Self {
		Self::DirectAccess(
			cpclib_runner::runner::emulator::Emulator::Ace(Default::default()))
	}

	pub fn new_cpcec_default() -> Self {
		Self::DirectAccess(
			cpclib_runner::runner::emulator::Emulator::Cpcec(Default::default()))
	}
