...
use task::FAP_CMDS;
use task::{
    ACE_CMDS, AMSPIRIT_CMDS, ARCHIVE_CMDS, ASMFMT_CMDS, AT_CMDS, AYT_CMDS, BASM_CMDS,
    BASMOPT_CMDS, BDASM_CMDS, BNDBUILD_CMDS, CADENCE_CMDS, CAPRICEFOREVER_CMDS, CHIPNSFX_CMDS,
    CONVGENERIC_CMDS, CP_CMDS, CPCEC_CMDS, CPCEMU_CMDS, CPCEMUPOWER_CMDS, CPR_CMDS, CSL_CMDS,
    DISARK_CMDS, DISC_CMDS, ECHO_CMDS, EMUCTRL_CMDS, EMULATOR_1984_CMDS, EXTERN_CMDS,
