...
use task::FAP_CMDS;
use task::{
    ACE_CMDS, AMSPIRIT_CMDS, AT_CMDS, AYT_CMDS, BASM_CMDS, BDASM_CMDS, BNDBUILD_CMDS,
    CAPRICEFOREVER_CMDS, CHIPNSFX_CMDS, CONVGENERIC_CMDS, CP_CMDS, CPCEC_CMDS, CPCEMUPOWER_CMDS,
    DISARK_CMDS, DISC_CMDS, ECHO_CMDS, EMUCTRL_CMDS, EXTERN_CMDS, HIDEUR_CMDS, HSPC_CMDS,
    IMG2CPC_CMDS, IMPDISC_CMDS, MARTINE_CMDS, MV_CMDS, ORGAMS_CMDS, RASM_CMDS, RM_CMDS,
    SJASMPLUS_CMDS, SONG2AKM_CMDS, SUGARBOX_CMDS, UZ80_CMDS, VASM_CMDS, WINAPE_CMDS, XFER_CMDS,
    Z80PROFILER_CMDS
};
use thiserror::Error;
...
use crate::executor::*;
use crate::task::{BASMDOC_CMDS, CATALOG_CMDS, CPC2IMG_CMDS, GRAFX2_CMDS, MINY_CMDS, RTZX_CMDS};
