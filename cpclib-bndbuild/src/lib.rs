...
use task::{
    ...
    IMG2CPC_CMDS, IMPDISC_CMDS, MARTINE_CMDS, MV_CMDS, ORGAMS_CMDS, RASM_CMDS, RM_CMDS, SJASMPLUS_CMDS,
    SONG2AKM_CMDS, SUGARBOX_CMDS, UZ80_CMDS, VASM_CMDS, WINAPE_CMDS, XFER_CMDS
};
use thiserror::Error;
...
use crate::executor::*;
use crate::task::{CPC2IMG_CMDS, GRAFX2_CMDS};
