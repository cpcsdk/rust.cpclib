...
use task::{
    ...
    CPR_CMDS, DISARK_CMDS, DISC_CMDS, ECHO_CMDS, EMUCTRL_CMDS, EXTERN_CMDS, HIDEUR_CMDS,
    HXCFE_CMDS, HSPC_CMDS, IMG2CPC_CMDS, IMPDISC_CMDS, MARTINE_CMDS, MV_CMDS, ORGAMS_CMDS, RASM_CMDS,
    RM_CMDS, SJASMPLUS_CMDS, SONG2AKM_CMDS, SUGARBOX_CMDS, UZ80_CMDS, VASM_CMDS, WINAPE_CMDS,
    XFER_CMDS, Z80PROFILER_CMDS
};
use thiserror::Error;
