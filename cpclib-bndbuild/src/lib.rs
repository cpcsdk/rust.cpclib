...
use task::FAP_CMDS;
use task::{
    ACE_CMDS, AMSPIRIT_CMDS, AT_CMDS, BASM_CMDS, BDASM_CMDS, BNDBUILD_CMDS, CHIPNSFX_CMDS,
    CONVGENERIC_CMDS, CPCEC_CMDS, CP_CMDS, DISARK_CMDS, DISC_CMDS, ECHO_CMDS, EMUCTRL_CMDS,
