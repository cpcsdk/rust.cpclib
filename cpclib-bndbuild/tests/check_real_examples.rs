...
#[test]
fn check_orgams() {
	let orgams_launch = |tgt: &str| {
		launch("tests/orgams", tgt).success()
	};
...
#[test]
fn check_delegated() {
	let delegated_launch = |tgt: &str| {
		launch("tests/delegated", tgt).success()
	};
...
#[test]
fn check_dummy() {
	let dummy_launch = |tgt: &str| {
		launch("tests/dummy", tgt).success()
	};
...
fn check_hello_world() {
	let dummy_launch = |tgt: &str| {
		launch("tests/hello_world", tgt).success()
	};
