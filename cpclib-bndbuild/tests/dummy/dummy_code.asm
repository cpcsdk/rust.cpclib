...
SCREEN_MEMORY_ADDRESS equ 0xC000
    ...
    ; Macro example
    ; We don't care if it is slow or memory inneficient here ! But ...
    ; TODO either use a system to generate efficient code based on some kind of CRTC state handling
    ...
    function load_palette
            ...
            print "Palette:", {hex}list_get(palette,0), " ", {hex}list_get(palette,1), " ", {hex}list_get(palette,2), " ", {hex}list_get(palette,3)
            return palette
    endfunction
