...
// Forward declaration of DocumentedItem for UndocumentedConfig
// The full enum is defined after the test module
...
// impl blocks for DocumentedItem (enum defined at top of file)
impl DocumentedItem {
