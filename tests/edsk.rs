...
mod tests {
    ...
    fn test_single_dsk(dsk: &cpclib::disc::edsk::ExtendedDsk) {
        ...
        assert_eq!(
            dsk.get_track_information(cpclib::disc::edsk::Side::SideA, 41)
                .unwrap()
                .data_sum(),
            329484
        );
    ...
    fn test_double_sided_bf_edsk(dsk: &cpclib::disc::edsk::ExtendedDsk) {
        ...
        assert_eq!(dsk.data_sum(cpclib::disc::edsk::Side::SideA), 66709468);

        assert_eq!(dsk.data_sum(cpclib::disc::edsk::Side::SideB), 54340792);
    }
