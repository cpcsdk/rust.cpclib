...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_001,
    r##########"10 print "bonjour" [RETURN] Vousremarquerez qu'apres avoir appuye sur [RETURN], bonjour nes'est pasaffiche a Pecran. IIs'estinscritdans la memoiredel'ordinateurpourformerun programmed'une ligne. Pourexecuterce programme, tapez run [RETURN] Vousverrezalors bonjourapparaitrea Pecran.Vouspouvez,sivousledesirez, rcmpla- cer PRINT par un point d'interrogation:
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_009,
    r##########"10 FOR a=10 TO 50 STEP 5 [RETURN] run [RETURN] Vous pouvez aussi fixer des pas negatifs
...
20 V=5:REM nosibre de vies [RETURN] Chapitre 1 Page 30 Courselementaire"##########,
    "page 41"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_010,
    r##########"10 ' Pan sur les envahisseurs [RETURN]
20 V=5' nombre de vies [RETURN] GOSUB Si un ensembledestructionsdoitetreexecuteplusieurs fois, vouspouvezeviterdereta- per les instructionsen creant un «sous-programme»dont 1'appel se faitgracea lacom- mande GOSUB. suiviedu numerode ligne requis. Lafin du sous-programmes'indique par RETURN. L'ordinateur passe alors a Instruction qui suit immediatement la com- mande GOSUB qu'il vient d'executer. (Les deux programmes suivants ne «font » rien d'autre qu'afficher des mots a I'ecran. Comme ils neservent qu'a illustrer Ie fonctionnementdes sous-programmes, il n'cst pas indispensablede lestaper). Par exemple, dans ce programme :"##########,
    "page 42"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_011,
    r##########"18 MODE 2 [RETURN]
...
160 PRINT [RETURN]
170 PRINT" P.Verlaine" [RETURN] - run [RETURN] Courselementaire Chapitte Page 31 1"##########,
    "page 42"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_012,
    r##########"10 MODE 2 [RETURN]
20 GOSUB 190 [RETURN]
...
220 RETURN [RETURN] run [RETURN] Nous avonsainsi gagne un temps precieux ! Lessous-programmes bien pensessont une partieessentielledela programmation. lisdebouchentsurdesprogrammes«structures» et sont un bon reflexede programmation. Lorsque vouscreez des sous-programmes, rappelez-vous qu'il vous est possible d'avoir plusieurs points d'entree. Par exemple, un sous-programme occupant les lignes 500 a"##########,
    "page 43"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_013,
    r##########"10 Turquoise 24 Jaune Vif
11 Bleu Ciel 25 Jaune Pastel
12 Jaune 26 Blanc Brillant
13 Blanc Tableau ! : Les numerosd'encre(INK)et lescouleurs Commenousledisionsauparavant,l'ordinateuresten mode 1 a Porigine. Pouryrevenir a partir d'un autre mode, tapez : mode [RETURN] I Chapitre 1 Page 48 Courselementaire"##########,
    "page 59"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_014,
    r##########"10 14 20 1
11 16 6 24
12 18 1 1
13 22 24 24
14 cIignotementI,24 20 1
15 clignotementl6,ll 6 24 Tableau2. ReferencePAPER/PEN/MODE/INK Chapitre 1 Page SO Courselementaire"##########,
    "page 61"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_015,
    r##########"10 MODE [RETURN]
...
70 FOR t=l TO vitesse [RETURN]"##########,
    "page 65"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_016,
    r##########"30 NEXT t,b [RETURN]
90 CLG [RETURN] "*
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_018,
    r##########"10 CLS
20 FOR X=l TO 39
30 LOCATE X,20
50 PRINT CHR*(250)
60 NEXT X
70 SOTO 10 run Faites [ESC] deux fois pour interrompre le deroulement. Chapitre 1 Page 56 Cours elementaire"##########,
    "page 67"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_019,
    r##########"40 FRAME Lacommande FRAME synchronisele mouvementde1'objetaffichesurla frequencede balayage de la trame d'affichage. Si cette notion vous parait trop technique, rappelez- vous simplement que cctte commande sert a deplacer harmonieusement sur lecran des caracteresou des graphiques. On peut encore ameliorer ce programme en ajoutant des petites pauses et en utiltsant d'autrescaracteres. Pource faire, tapez : list Puisajouter les lignessuivantes au programme :
...
140 GOTO 20 run Coursetementaire Chapiire 1 Page 57"##########,
    "page 68"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_020,
    r##########"10 PLOT 10,10
20 DRAW 10,390
30 DRAW 630,390
40 DRAW 630, 10
...
110 NEXT run Pourexperimenter une autre methodedecreation d'uncercle, tapez Ie programme : new"##########,
    "page 73"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_025,
    r##########"10 MODE 1
20 ORIGIN 320,200
30 DEG
40 MOVE 0,190
...
70 NEXT run Cettefois, uneligneesttracee (DRAW)decoordonneeen coordonneesurPensemblede la circonference. Le tracageest nettement plus rapide que Ie positionnementdes points. Unefoisencore, observe? la consequencedu retrait de la commande DEG parsuppres- sion de la ligne 30 et relancez le programme. FILL La commande FILLsertaremplir unezoned'ecrandelimiteeparunecourbe, le bord de l'ecran, ou d'une fenetregraphique. Reinitialiseza l'aidedes touches [CONTROL] [SHIFT] et [ESC], puistapez new"##########,
    "page 73"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_026,
    r##########"10 CLS
20 MOVE 20,20
30 DRAW 620,20
40 DRAW 310,380
50 DRAW 20,20 run 3hapitre Page 62 Courselementaire 1"##########,
    "page 73"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_027,
    r##########"50 DRAW 50,50
60 MOVE 320,200
70 FILL 3 run Toute interruption de lignes sur Pecran laisse « passer» la couleurdu stylo. Ce phenomene est illustre par le remplissaged'un cercle positionne a Pecran, puisd'un cercle trace. Tapez new"##########,
    "page 74"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_028,
    r##########"10 CLS
20 FOR a=i TO 360
30 ORIGIN 320,200
...
50 NEXT
60 MOVE -188,0
70 FILL 3 run Cowselementdire Chaprtre 1 Page 63"##########,
    "page 74"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_029,
    r##########"10 MODE 1
20 ORIGIN 320,200
30 DEG ; /"-
40 MOVE 0,190
...
70 NEXT
80 MOVE -188.0
90 FILL 3 run Vouspouvezrendrelacirconferenceducercleinvisibleenutilisant la memecouleurpour le stylo etle papier. Ajoutezcette ligne :"##########,
    "page 75"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_030,
    r##########"10 MODE 0: BORDER 13
...
130 FOR t=t TO 500: NEXT:GOTO 110 run Chapitre 1 Paye 64 Cours61&nentaire"##########,
    "page 75"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_031,
    r##########"10 BORDER 0;GRAPHICS PEN t
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_032,
    r##########"60 MOVE 0,0;DRAW x,300:DRA»l 0,688
90 MOVE 0,0:DRAW -x,300:DRAW 0,680
180 NEXTrFOR t-\ TO 2000:NEn :G0TO 28 run"##########,
    "page 76"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_033,
    r##########"10 rlODfe 1 1 BORDER 0IHAP6R 1
...
140 NEXT 1-58 FLAG=llRETURN run Courselementaire Chapiire Page 65 ]"##########,
    "page 76"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_034,
    r##########"10 MODE 1: BORDER 0:DEG
...
610 INK 3, IK(3)
620 RETURN Courselementaire Chapitre 1 Page 67"##########,
    "pages 77, 78"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_035,
    r##########"10 SOUND 1,239,200 run La meme notedo dure 2 secondes. >3*vt:i;;-.v Volume Ce parametredeterminelevolumededepartd'unenote. Cenombrc variedc a15. correspond au volume minimum et 15 au volume maximum. En I'absence de specifica- tion, I'ordinateurfixe un chiffredc12. Tapez :
10 SOUND 1,239,200,5 run Remarquez le volumedu son, puis tapez un numerodevolume superieur
10 SOUND 1,239,200,15 run Vousdevez obtenir un son plusfort. Cours61ementaire Ch«pttre ! Page 06"##########,
    "page 80"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_036,
    r##########"10 ENV 1,10,1,100
20 SOUND 1,142,1000,1,1 run Chapitre Page 71 Courselemenwire 1"##########,
    "page 82"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_037,
    r##########"10 pas, eievant chaque pas d'une unite de volume et durant une seconde (1 00 x 0,01 sec). Change? la ligne 10 de la maniere suivante et faites run chaque fois pour entendre la difference
10 env I, 100, 1,10
10 env 1,100,2,10
10 env 1,100,4,10
10 env 1,50,20,23
...
70 NEXT run Tout celaest fort bien, mais nous n'avons pas Tintention d'entrer les 100 noms en une seule fois. Dc plus, la presentation du programmea l'ecran laisse beaucoup a desirer. II s'agit maintenant d'ymettreunpeud'ordre. Pourcommencesnousallons,avantchaque nouvelle entree, debarrasser l'ecran du tcxte anterieur devenu inutile. C'cst I'arTairc de CLS 1'instruction :"##########,
    "page 106"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_044,
    r##########"55 If- NQflStx )="" THEN 90
80 PRINT"entree des donnees terminee" Le programme doit lui-meme indiquer a I'utilisateur commentTinterrompre. Ajoutons done"##########,
    "page 107"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_045,
    r##########"47 PRINP'pour arreter appuver [ENTER]" Voyonsmaintenantcomment obtenirTimpressiondesinformationsenregistrees,d'abord sous forme de liste. Ecrivons
90 FOR X*I TO 180
100 PRINT N0M*(x)?" ";TEL$(x)
110 NEXT Maislaencore le programmenesait pascomment s'arreteravantlecentiemeelementdu tableau, Ajoutons done"##########,
    "page 107"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_046,
    r##########"95 IF N0M$(x)="" THEN 120
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_047,
    r##########"130 NEXT
190 PRINT "Lb n'jin r. >^i r-a< ren <?r t c;>i*? *" run Chapitre2 Page 4 Passonsauxchosesserieuses. ."##########,
    "page 107"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_048,
    r##########"32 PRINT"!, ajouter un correspondant "
...
200 RETURN Vousremarquezqu'acertainsendroitsnouscommenconsa manquerdeplace pourinsu- RENUM- rer de nouvellcs lignes. Nous allons en crcer et remettre un peu d'ordre en erotant les lignes. Faites : RENUM LIST Vousdevez maintenant obtenir"##########,
    "pages 109, 110"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_050,
    r##########"18 REM repertoire teiephonique
20 DIM NOM$U80)
30 DIM TEU$(100)
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_051,
    r##########"350 0PEN0UT "donnees"
360 FOR x=i TO 100
...
480 RETURN Chapitre2 Page 10 Passonsauxchoses«£rieuses.."##########,
    "pages 112, 113"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_052,
    r##########"34 MODE 1 Ceci determine le mode d'afirchage: 1'ecran sera efface a chaque nouvelleexecution du programme. Ecrivezensuite
...
560 RETURN run Chapitre2 Page 14 Passonsauxchosesaerieuses."##########,
    "pages 116, 117"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_054,
    r##########"10 AFTER 250 SOSUB 60:CLS
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_070,
    r##########"30 EltNEXTsGQTO 20
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_071,
    r##########"20 DIM ami$(S),tel*(5)
38 FOR n= l TO 5
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_072,
    r##########"70 FOR n=l TO 5
100 PRINT n;a»ii(n),telt(n)
110 NEXT run COMMANDS DIMensionne un tableau. Cettecommande alloue l'espace requis aux tableaux et speci : fic les valeurs d'indices maximales. Le BASIC doit connaitre l'espace reserve pour un tableau, en fabsence de specification il prend 10 comme valeur par defaut. Untableauestidentifieparune <variableindiceo, asavoirunnomdevariableaccom- pagned'unensembled'indicesafinquechaque«element»dutableauaitsaproprevaleur d'indice. Uneboucle FOR NEXT peutserviracontrolerletableauen traitantchaqueelementdu tableau a tour de role. La valeurminimaled'un indiceestzero (e'est lepremierelement d'un tableau). Les tableaux peuvent etre multi-dimensionnels et chaque element est reference par sa position. Par exemple, dans un tableau dimensionne par DIM position$*20,20,20> ...un element du tableau sera reference de la facon suivante : position* (4, 5, 6) ERASE Motscles associes : Chapitre3 Page 18 Motsci*sduBASIC"##########,
    "page 136"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_073,
    r##########"10 MODE BiBORDER 0:PAPER 0: INK 0,0
20 x=RND*640:y=RND*400:z=RNDU5
30 DRAW x,y,z
40 GOTO 20 run COMMANDE : Traceunelignesurl'ecranentrela positionducurseurgraphiqueetune positionabsoluespecifieeparlescoordonneesxety. L'<encre> detracage peutetrespe- cifiee (entre et 15). Le <moded'encro facultatifdetermine1'interaction de 1'encresur I'affichagepresent a l'ecran. Lesquatre <modes d'encro sont les suivants : 0: Normal I:XOR(OUexclusif) AND 2: (ET) OR (OU) 3: Motsclesassocies : DRAWR. GRAPHICS PEN, MASK DRAWR DRAWR <decalage x>,<decalagey>[,[ <encre >][, <moded'encre>]]"##########,
    "page 137"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_074,
    r##########"10 CLS;PRINT"tu montes au premier !?"
20 MOVE 0,350:FQR 0*1 TO 8
30 DRAWR 50,0
40 DRAWR 0,-50
50 NEXTsMOVE 348 0iFlLL 3 ( .
60 GOTO 60 run COMMANDE Traceunelignesurl'ecrangraphiqueapartirducurseurgraphiquejus- : qu'alapositionspecifieeparles <decalagesxety>. L'<encre> dutracepeutetrespeci- fiee (entre et 15). MotsclesduBASIC Chapitre3 Page 19"##########,
    "page 137"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_075,
    r##########"10 ENV 1,15,-1,10,15,1,10
20 SOUND 1,200,300,15,1 run COMMANDE : Definit PENveloppe de Volume cdrrespoodant au <numero d'enve- loppe> (entre 1 et 15). utilise avec la commande SOUND. Elle peut contenir 2 ou 3 parametres Pour 3 parametres <nombre de pas>,<amplitude du pas>,<dureedu pas>. Parametre 1 <nombredepas> : Specifie Ic <nombrede pas> devolumequ'un sondoit traverserdans lasection d'enve- loppe. Parexemple,dansunesectionde 10secondes, vouspouvezfixer 10pasdevolume duneseconde. Le parametre <nombredepas> est egal a 10. Le parametre peut varierde a 127. Parametre2 <amplitudedu pas> : Peutfairevarierlevolumede a 15parrapport au pas precedent. Les 16volumesdiffe- rentssont les memesqueceux de la commande SOUND. Le parametre <amplitudedu pas> peutcependant varier de -128 a + 127. le volume revenant a apresavoir atteint 15. Parametre 3 <dureedu pas> : Specifieladurecd'un pasenunitesde0,01 seconde. Peut varierde a 255(0a la valeur 256), soit 2,56 secondes. MotsctesduBASKJ. Chapitre3 Page 23"##########,
    "page 141"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_076,
    r##########"18 OPENIN "exl.bas"
20 WHILE NOT EOF Uixt Jar.
30 LINE INPUT #9,a»
40 PRINT a«
50 WEND
60 CLOSEIN run FONCT10N : Pourtesterl.'etat d'un fichierouvert. Donne - 1 (vrai)si Tonesten fin de fichier(EnfOfFile)ou si aucun fichier n'estouvert, sinon donne (faux). Motscles associes : OPENIN, CLOSEIN ERASE ERASE <liste de:<nomde variable> DIM a(100>,b$(100> ERASE a,b$ COMMANDE Quand un tableaun'estplusnecessaire,il peutetreefface(ERASE)afin : deliberer la memoire pourd'autresutilisations. DIM Motscles associes : ERL ERL"##########,
    "page 143"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_077,
    r##########"10 ON ERROR BOTO 30
20 BOTO 1000
30 PRINT"L'erreur est en ligne";ERL
40 END run FONCTION Donnele numcrodelignedeladerniereerreurrencontree. Dans1'exemple ci-dessus TERr : eur de la Ligne 20 est indiquee par la fonction ERL. Mots cles associes : DERR, ERR, ERROR, ON ERROR GOTO, RESUME MotsclesduBASIC Chapitre3 Page 25"##########,
    "page 143"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_078,
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_088,
    r##########"10 CLS
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_094,
    r##########"10 LINE INPUT "tapez une ligne de texte ponctuet. "?»«
28 CLS
30 PRINT"la variable a* est bien egale a :-"
48 PRINT a$ run COMMANDE Recoit une ligne entiere en provenance du canal indique (# en : ['absencedespecification). Lepremier [;] point-virgulefacultatifsupprime leretourcha- riot/sautde ligne qui intervient normalement aprcsexecution de ia commande. Le <separateur> peutetreunpoint-virguleouunevirgule. Lepoint-virguleentraineI'af- fichaged'un point d'interrogation ; la virgule le supprime. L'entreede LINE INPUT au clavierse termineparractivation de la touche [RETURN]. LI NE I NPUT enprovenanceducanal§9deIadisquette(oudelacassette)seterminepar un retourchariotou parl'affectationdeplusde255caracteresala <variableenchaine> Motscles associes INPUT : LIST L I ST [ <ensemblede lignes> ][, <numerodecanal> ] LIST 100-1000, #1 COMMANDE : Ltstele programmesurle canaldesire, n est 1'ecran, ft 8 est Pimpri- mante. Le LISTage peut etre provisoirementinterrompu sivous appuyez unefoissurla touche [ESC], pouretreensuite reprisa l'aidedelabarred'espacement. Sivousappuyez deux fois sur [ESC], vousarretez le listageet revenez au modedirect. Vouspouvezomettre le premierou ledernier numerode lignedu parametre <ensemble de lignes> pour lister le programme depuis le debut, ou jusqu'a la fin. Exemples LIST -200 Chapitre3 Page 40 MotsclesduBASIC"##########,
    "page 158"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_095,
    r##########"10 MODE 1
20 FOR n=i TO 20
30 LOCATE n,n
40 PRINT CHR«(143);"pofiition";
50 PRINT n;\"jn :-.-
60 NEXT run COMMANDE : Deplacele curseurde texte vers une nouvelle position relative aucoin superieur gauche de la fenetre (WINDOW). // represente lecanal pardefaut. WINDOW Mots cles associes ; Motscl6a duBASIC Chapitre3 Page 41"##########,
    "page 159"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_096,
    r##########"10 a*="REGARDEZ COMMENT LES LETTRES SUNT CHANGEES "
20 PRINT LQWER*U* +"EN TYPE MINUSCULE") run FONCTION Changetouteslesmajusculesd'unechainealphanumeriqueenminuscules. : Utilequand on attend desreponsescomposeesd'un melangedemajusculeset deminus- cules. Motsclesassocies UPPERS : iftHV Chapitre3 Page 42 MotsctesduBASIC"##########,
    "page 160"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_097,
    r##########"20 MOVE -100*RND,400tRND
30 WHILE XPQS<640
40 FDR x=l TO 8
50 MASK. 2t(8-x)
...
100 GOTO 50 run Chapitre3 Page 44 Motsc!6sduBASIC"##########,
    "page 162"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_100,
    r##########"18 a*="bonjour"
28 rHD*(a*,3,2)»"XX"
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_101,
    r##########"10 D't+liIF a>2 THEN «*0
20 MDDE in
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_102,
    r##########"20 x=RND*800-100:y=RND*430
30 MOVE x,y
40 PRI N T "je suis ici"s
50 SOTO 28 -.-:,:> run COMMANDE : Positionne lecurseurgraphiqueau pointabsolu specifie. Le parametre facultatif <encre> (compris entre et 15) permet de changer la couleur du stylo graphique. % Chapitre3 Page 46 MotsclesduBASIC"##########,
    "page 164"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_103,
    r##########"20 PRINT"la vie a set";
30 FOR n=l TQ 10
40 MOVER -45,16
50 PRINTuhauts"i:NEXT!PRINTH tt"j '
60 FOR n=l TO 10
70 MOVER -64,-16
80 PRINT"bas";:NEXT run COMMANDE : Positionne le curseur graphique en coordonnees relatives(par rapport a lapositionactuelle). Le parametrefacultatif<encre> (comprisentre et 15)permetde changer la couleur du stylo graphique. Leparametrefacultatif<moded'encre> determinel'interactiondeI'encresuri'affichage en place a Pecran. II existe4 <modes d'encro : 0: Normal 1: XOR (OU exclusif) AND 2: (ET) 3: OR (OU) Motscies associes MOVE, ORIGIN, XPOS, YPOS : tu> Motsc!esduBASIC Chapitre3 Page 47"##########,
    "page 165"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_104,
    r##########"10 FOR a=l TO 3
28 FOR b= TO 26
30 MODE 1
40 PEN a: BORDER b
...
70 NEXT c,b,a run COMMANDE: Marque la fin d'une boucle commencee avec FOR. La commande NEXT peut etre anonyme ou peut se rapporter au FOR concerne. Dans t'exemple ci- dessus, la <listede;variable> doitapparaitreensensinversedela specificationdescom- mandes FOR, afin d'eviter lechevauchement des boucles imbriquees. Motscles associes FOR, STEP, TO : NOT NOT <argument> IF NOT "alain" < "bernard" THEN PRINT "vrai" ELSE PRINT Maux" faux IF NOT "chat" > "chien" THEN PRINT "vrai" ELSE PRINT "faux" vrai PRINT NOT -1 PRINT NOT -1 OPERATEUR : Executedesoperationsparbitsurdesentiers. Inversechaquebitde['ar- gument. Pour dc plus amples informations, consultez la partie 2 du chapitre « A vos heures de loisir... ». Motscles associes AND. OR, XOR : Chapitre 3 Page 48 Mot*cWsduBASIC"##########,
    "page 166"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_105,
    r##########"10 ON BREAK CONT
20 PRINT"Le programme CONTinuera si vou* tssayez o« fai. rt IB U reak* avec touche CESC]":PRINT .30 FOR t= l TO 1000:NEXT:GOTO 20 run COMMANDE AnnuleTactiondela touche [ESC],empechant rarretdu programme. : Cettecommandeest a utiliseravecprecautioncar)e programmenepeutalorsetreinter- rompu que parreinitialisationcompletede l'ordinateur(vousdevezdonesauvegarder le programme avant de le lancer). Vouspouvezdesactiver ON BREAK CONT par ON BREAK STOP a 1'interieurd'un programme. ON BREAK GOSUB, ON BREAK STOP Motscles associes : ON BREAK GOSUB ON BREAK GOSUB <numero de ligno"##########,
    "page 167"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_106,
    r##########"10 ON BREAK GOSUB 40
20 PRINT"le programme tourne"
30 GOTO 20
40 CLS;PRINT"Appuyer 2 fais C ESC 3 , "
50 PRINT"appeUe le sous-programme"
60 FOR t=l TO 2000:NEXT
70 RETURN run COMMANDE: Demande au BASIC de passer an sous-programme specific par le <numero de ligne> lorsque vous appuyezdeux foissur [ESC]. Motscles associes : ON BREAK CONT. ON BREAK STOP, RETURN MotsclesduBASIC Chapitre3 Page 49"##########,
    "page 167"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_107,
    r##########"10 ON BREAK 60SUB 40 *
20 PRINT"le programme tourne*
30 GOTO 20
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_108,
    r##########"10 ON ERROR GOTO 60
...
80 LIST
90 AUTO
100 CAT run COMMANDE Selectionneunelignea laquellele programmedoitsauterenfonctionde : la valeurdu <selecteur> (nombreentiercomprisentre et255). L'ordredes valeursdu <selecteur> determinelenumerodeligneaextrairedela <l«stede:<numerosdelignes> Dans Texempleci-dessus"##########,
    "page 170"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_111,
    r##########"10 ENV 1,15,-1,1
20 ON SQdl GOSUB 60
...
90 GOTO 90 run COMMANDE ; Affiche, enmodegraphique, le point decoordonneesxety. On definit l*<encre> dece point sur une echelle de a 15. Leparametre facullatif <moded'encro determinele moded'interaction entrelacouleur utiliseeet celle de 1'ecran. Voici lesquatre modespossibles Normal :"##########,
    "page 175"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_119,
    r##########"40 IF 2NKEY(0)=0 THEN PLOTR ,1
...
90 GOTO 40 run COMMANDE Enmodegraphique,afilcheal'ecranlepointdecoordonneesxetyrela- tives a la positi : on du curseur a ce moment. On definit l'<encre> de ce point sur une echellede a 15. Le parametre facultatif <mode d'encro definit le mode d'interaction entre lacouleur utiliseeet cellede l'ecran. Voici les quatremodespossibles : Normal : XOR (OU exclusif)"##########,
    "page 176"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_120,
    r##########"10 FOR =49152 TO 65535 ii
20 POKE ft, IBB
38 NEXT run COMMANDE Inscrit la valeur correspondant au <nombre entier> (compris entre et 255) directem : ent dans la case de la memoire vive (RAM) du Z80dont l'<adresse> est indiquee. Commande a utiliseravecprecaution ! Mots clesassocies : PEEK Chapltre„3 „ Page 5n8o MotsctesduBASIC"##########,
    "page 176"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_121,
    r##########"10 MODE Is BORDER BiLOCATE 8,2
...
50 PRINT
60 PRINT b*;b*
70 PRINT b*,b* ... run COMMANDE Transmet la >liste de:<article a imprimer> ou a afficher sur lecanal : indique, (i0 par defaut). MotsclesduBASIC Chapitre3 Page 59"##########,
    "page 177"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_123,
    r##########"10 PRINT"ceci est 1' instruction SPC"
20 FOR k=6 TO 15
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_131,
    r##########"10 AFTER 520, GOSUB 40 1
...
70 RESUME run Mots cles associes : O D N ER E L R E R R O L. R E G R O R T , O, ERROR, RESUME NEXT Mobc.esduBASIC Chapitre3 Pag* 67"##########,
    "page 185"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_135,
    r##########"10 ON ERROR SOTO 90
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_148,
    r##########"20 b»4tX 1 1 1 1 s REM 15 binaire
38 c*="**t"
40 PRINT c*+STRtU+b)+c* run tit 270*1* FONCTION Fournitsousformedechainealphanumeriquelarepresentationdecimale : de1*<expression numerique> indiquee.: Mots cles associes : BIN$, DECS, HEX$, VAL „ Chapitre3„ „ Page 78 Motsc!6sduBASSC"##########,
    "page 196"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_149,
    r##########"10 MODE 1:SYMBOL AFTER 105
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_150,
    r##########"60 rangee7=i29;REM 10000001 en binaire
90 rangee8=255:REM 11111111 en binaire
100 PRINT"La ligne 110 redefinie la lettre i(105). Tapez que lques 'i' et regardez !"
110 SYMBOL 105, rangeel rangee2, rangeeS, rangee4, rangee5, range e6,rangee7,rangee8 , run COMMANDE : Rcdefinit la formed'uncaractereafftcheaI'ecran.Chacundesparame- tres prend une valeur entiere situee entre et 255. duBASIC Chapitre3 Page 79"##########,
    "page 197"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_151,
    r##########"10 CLS
20 SYMBOL AFTER 115 .\
...
70 PRINT"SYMBOL AFTER 240" run COMMANDE : Fixela limiteinferieuredes numerosdecaracteresredefmissables(de a 255). La valeur par delaut du nombre entier est de 240, auquel cas on dispose de 16 caracteres redefinissables (entre 240 et 255). Lorsque le <nombre entier> a pour va- leur 32. tous les caracteres situcs entre 32 et 255 sont redefinissables. La eommande SYMBOLAFTER 256 interdit done toute redefinitiondecaractere. Laeommande SYMBOLAFTER retablitlavaleurpardefautdetouslescaracterespre- cedemment redefinis. MotsciesduBASIC Chapitre3 Page 31"##########,
    "page 199"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_152,
    r##########"20 PRINT"Quel va et vient "ja*}" !!"
30 TAG
...
70 GOTO 78 run COMMANDE: Annule la commande TAG concernant le canal indique (ff par defaut). Le textesetrouve doneanouveau dirigesur la positionducurseurde texte. TAG Motscles associes : TAN TAN (<expression numeriquo) PRINT TAN(45) 1.6197751V FONCTION Calcule la TANgente de I'<expression numeriquo, qui doit etre com- : priseentre-200000et +200000. On peut exprimer I' argument en degres ou en radians par 1'intermediaire des fonctions DEG et RAD, respectivement. Mots cles associes : ATN, COS, DEG, RAD, SIN Mo««*a<feiBASIC Chapitre3 Page 83"##########,
    "page 201"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_154,
    r##########"20 PRINT'Vous utilisez le stylo (pen) Not "}
30 PRINT TESTU2,394)
40 PRlNT"Changez de mode et de stylo"!
58 PRINT"... puis faites RUN." run FONCTION : Placelecurseurgraphiquea la position deftnieparx ety(encoordonnees absolues) et indique la valeur du parametre <encre> a cet endroit. Motsclesassocies MOVE, MOVER, TESTR, XPOS, YPOS : TESTR TESTR (<decalage x>,<decalagey>) /TAT"##########,
    "page 202"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_155,
    r##########"10 MODE 0:FOR x=t TO ISjLOCATE 1,x
20 PEN xsPRINT STRING*<IB, 143) tNEXT ;
30 HOVE 200,400:PEN 1
40 FOR n=l TO 23ilQCATE 12,
50 PRINT'pen";TESTR(0,-161:NEXT run FONCTION : Place lecurseur sur une position decoordonnees x et y par rapporta sa position actuelleet indique la valeurdu parametre <encre> a cet endroit. Mots cles associes : MOVE, MOVER, TEST, XPOS, YPOS THEN (voirIF) ChapitreS Page 84 MottCl6»duBASC"##########,
    "page 202"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_156,
    r##########"18 CLSiREK horlog*
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_157,
    r##########"10 TROFFiPRINT;PRINT"TROFF"
20 FOR n=l TO 8
...
100 PRINT*!, VPQS(*B> sGOTO 50 run FONCTION Indique, sur 1'axe Vertical, la POSition du curseur de texte, a partirdu : bordsuperieurdela fcnetredetexte. L'indicateurdecanaldoit obligatoirement figurer il ne prend pas la valeur # pardefaut. WINDOW Mots cles associes : POS, dteduBASIC Chapitre3 Page 67"##########,
    "page 205"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_160,
    r##########"10 CL6 :PR NT "chronometre dt 10 socondes": t-TIHE
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_161,
    r##########"10 MODE 0:BQRDER 0j REM cibU tv
...
90 PAPER 5iWIND0W 14, 16, 18iCLS"##########,
    "page 207"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_162,
    r##########"100 PAPER 6:WIND0W 17, 19, 18s CLS 1
110 PAPER 7: WINDOW 2, 19, 9, 25: CLS 1
120 GOTO 120 run COMMANDE Enmode texte, indique lesdimensionsd'un canal d'affichage a Tecran : (on parte dans ce cas de fenetre). On veillera a ce que les valeurs des parametres <gauche>, <droite>. <haut> et <bas> correspondent bien aux coordonnees en vigueurdans le MODF.-ecran utilise. Le <numero de canal> prendra par defaut la valeur ff 0. Pour plusde detailsconcemant les fenetres, voirla deuxierrie partie duchapitre intitule «A vos heures de loisir... ». WINDOW SWAP Motscles associes : MotaclfcduBASrC Chapitre3 Page 86"##########,
    "page 207"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_163,
    r##########"10 MODE 1: INK i, 24: INK 2,9:INK 3,6
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_164,
    r##########"10 REM ecrit des donnees sur la disquette
20 INPUT "donnez-moi un nombre";a
30 INPUT "donnez-moi une chaine de caracteres"} a$
40 OPENOUT "NOMFICH"
50 WRITE #9,a,a$
60 CLOSEOUT: PRINT "Les donnees sont sauvees sur disquette' run COMMANDE : Affiche ou ecrit (WRITE) desdonnees sur le canal indique. Deux arti- clesdistinctsdoiventetresepares parunevirguleet leschainesdecaracteressontplacees entre guillemets. Chapitre3 Page 90 MotsclesduBASIC"##########,
    "page 208"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_165,
    r##########"10 REM retrouve les dannees sur la disquette
20 DPENIN "NOMFICH"! INPUT *9,a,a$
30 CLQSEIN;PRINT"les 2 donnees sonts"
40 PRINT:PRINT a, a* run Motscles associes INPUT, LINE IN PUT : XOR XOR <argument> <argument> IF "alain" < "bernard" XOR "chien" > "chat" THEN PRINT "vrai" ELSE PRINT "faux" faux IF "bernard" < "alain" XOR "chat" > "chien" THEN PRINT "vrai" ELSE PRINT "faux" faux IF "alain" < "bernard" XOR "chat" > "chien" THEN PRINT "vrai" ELSE PRINT "faux" vrai PRINT AND"##########,
    "page 209"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_166,
    r##########"10 MODE liDRAW 320,200
20 PRINT"POSition X du curseur graphiquB=";
30 PRINT XPOS run FONCTION : Indique, surl'axe horizontal (X), la POSition ducurseurgraphique. Motsclesassocies MOVE, MOVER. ORIGIN. YPOS : YPOS YPOS"##########,
    "pages 209, 210"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_167,
    r##########"10 MODE ltDRAW 320,200
20 PRINT"PQSition Y du curseur graphique=";
30 PRINT YPOS run FONCTION : Indique, surl'axe vertical (Y), la POSition du curseur graphique. Motsclesassocies : MOVE, MOVER, ORIGIN, XPOS ZONE ZONE <nombreentier>"##########,
    "page 210"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_168,
    r##########"10 CLS:F0R z =2 TO 20
20 ZONE z
30 PRINT "X","X ZONE s-jzsNEXT run COMMANDE : Modifielalargeurdela tabulationdesignee par la virguledansla com- mande PRINT. La largeurdes zonesd'affichageou d'impression, (de 13 caracteres par defaut), peut ainsi prendre une valeurentiere quelconque entre 1 et255. Motsclesassocies PRINT : Chapitre3 Page 92 Motsel6eduBASIC"##########,
    "page 210"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_169,
    r##########"10 dumpf le*="flagdufflo.srii" i
20 MODE 1: BORDER"##########,
    "page 233"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_170,
    r##########"40 FOR 1^0 TO 2
...
240 x=-&5:«=248:y=40a:b=-15B:iiQSUB 400 Chapitre5 Page 6 Leselementsdei'AMSDOSelduCP/M"##########,
    "page 233"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_171,
    r##########"260 x=575:a=-240:y=400:b=-150:l3QSUB 400
...
120 LOAD filename* run Sommaire des commandes externes d'AMSDOS IA !A COMMANDE : Dirige les entrees/sorties vers l'unite A. Equivalent a | DRIVE avec A pour parametre. (L'unite integree est 1'uniteA.) IB B COMMANDE Dirigelesentrees/sortiesversl'uniteB.Equivauta DRIVEavecBpour : | parametre. (L'unite integreeestl'unite A.) Chapitre5 Page 8 LeselementsdeI'AMSDOSelduCP/M"##########,
    "page 235"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_173,
    r##########"10 QPENOUT "PROFILE.SUB"
20 PRINT #9,"5ETKEYS KEYS.CCP"
30 PRINT #9, "LANGUAGE 3"
40 CLOSEOUT Codes de controle de la console L'univcrs CP/M, c'est aussi un ensemble de codes clavier speciaux pour controler le deroulemcntdesprogrammes.Cescodesremplacentle[ESC]du BASICetlestouchesde deplacement du curscurdu BASIC AMSTRAD. Les codes de controle ci-dessous sont affectes apres lancement de la eommande : Lescodesdecontrole ci-dessous sontaffectesapreslancement de la eommande : SETKEYS KEYS.CCP Le programme transitoire SETKEYS.COM et le fichierdeeommande KEYS.CCP se trouvent surla face I d'unedesdisquettes systeme. Codedecontrole Touche Action [C0NTR0L1A <3 Deplacelecurseurd'uncaractereversla gauche [CONTROL]B [CONTROL]^ Deplace le curseurjusqu'au debut de la ou ligne ou. s'il s'y trouve deja, en fin de [CONTROL]^ ligne. [CONTROL]C [CONTROL][ESC] Abandon [CONTROL]E [CONTROL][RETURN] Retourchariot physique [CONTROL]F O Deplacelecurseurd'uncaractereversla droite [CONTROL]G [CLR] Efface lecaractere situesouslecurseur [CONTROL]H [DEL] Effacement du caractere precedant le curseur [CONTROL]! [TAB] Deplace lecurseurjusqu'a la tabulation suivante ;- [CONTROL^ „-. V.i,-: Validation de la ligne de eommande LeselementsdeIAMSDOSeiduCP/M Chapitre5 Page 19"##########,
    "page 246"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_174,
    r##########"600 NUL Pasd'effet. Ignore.
601 SOH 0a255 Affiche le symbole correspondant a la 1 valeur du parametre. Permel ainsi l'affichage dessymbolesde a 31"##########,
    "page 309"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_175,
    r##########"615 21 NAK Desactive I'ecran de texte. Rien ne s'affichera jusqu'a ce qu'un caractere ACK (&066)ait eteenvoye.
616 22 SYN a 1 Parametre modulo 2. supprime le mode transparent, 1 etablit le mode transparent."##########,
    "page 311"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_176,
    r##########"11 013 OB VT([CTRL]K) 61 075 3D = 111 157 6F"##########,
    "page 314"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_177,
    r##########"14 016 OE SO([CTRL)N) 64 100 40 (S 114 162 72 r
...
20 024 14 DC4([CTRLJT) 70 106 46 F 120 170 78 X"##########,
    "page 314"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_178,
    r##########"25 031 19 EM(ICTRL)Y) 75 113 4B K 125 175 7D I
...
49 061 31 1 99 143 63 c 1 Chapitre7 Page 8 Dourinformation..."##########,
    "page 314"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_179,
    r##########"32 &H20 &X001ooooo rr --S --S :__
...
45 46 47 48 &H2D &H2E &H2F &H30 &X00101101 &X00101110 &X00101111 &X00110000 Chapitre7 Page 9 Pourinformation."##########,
    "page 315"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_180,
    r##########"53 54 55 56 &H35 &H36 &H37 m &H38 &X00110101 &X00110110 &X00110111 &X00111000 m «:::
...
85 86 87 88 &H55 &H56 &H57 &H58 &X01010101 &X01010110 &X01010111 &X01011000 Chapitre7 Page 11 Pour information .."##########,
    "pages 316, 317"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_181,
    r##########"89 90 91 92 &H59 &H5A 4H5B 4H5C 4X01011001 &X01011010 4X01011011 4X01011100 e p= !
93 94 95 96 4H5D 4H5E &H5F 4H60 4X01011101 &X01011110 &X01011111 4X01100000 Til IT"##########,
    "page 318"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_182,
    r##########"97 98 99 100 4H61 4H62 4H63 4H64 &X01100001 4X01100010 &X01100011 &X01100100
...
145 146 147 148 &H91 &H92 SH93 &H94 &X1O010001 &X10010010 &X10010011 &X10010100 Chapilre7 Page 14 Pour information."##########,
    "pages 318, 319, 320"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_183,
    r##########"149 150 151 152 &H95 &H96 &H97 &H98 &X10010101 &X10010110 &X10O10111 &X1O01100O mm
...
205 206 207 208 &HCD &HCE &HCF &HD0 &X11001101 &X11001110 &X11001111 &X11010000 Chapitre7 Page 1? Pourinformation."##########,
    "pages 321, 322, 323"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_184,
    r##########"209 210 211 212 &HD1 &HD2 &HD3 &HD4 &X11010001 &X11010010 4X11010011 &X11010100 »_ I m :: _-. _
...
245 246 247 248 &HF5 &HF6 &HF7 &HF8 &X11110101 &X11110110 &X11110111 4X11111000 Pourinformation. Chapitre7 Page 19"##########,
    "pages 324, 325"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_185,
    r##########"249 250 251 252 &HF9 &HFA &HFB &HFC &X11111001 4X11111010 &X11111011 &X11111100 W m las
253 254 255 &HFD &HFE &HFF &X11111101 &X11111110 &X11111111 i... J. J Chapitre7 Page 20 Pour information."##########,
    "page 326"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_186,
    r##########"135 137 N/A N/A N/A N/A N/A N/A N/A N/A N/A N/A N/A N/A N/A IN/A RN/A 136
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_187,
    r##########"174 614 358 +0,.019% Fn
184 997 338 +0,,046% G 195 998 319 +0, .037% G# 207 652 301 +0.005% A 220 .000 284 -0.032% A# 233 .082 268 -0.055% B 246 .942 253 -0.038% NOTE FREQUENCE PERIODE ERREUR RELATIVE 261.626 239 +0.046% Do medium c c# 277.183 225 -0.215% D 293.665 213 +0.081% D# 311.127 201 +0.058% 329.628 190 +0.206% E 349.228 179 +0.019% Octave F F# 369.994 169 +0.046% G 391.995 159 -0.277% 415.305 150 -0.328% Gti A 440.000 142 -0.032% A international A# 466.164 134 -0.055% B 493.883 127 +0.356% Chapitre7 Page 25 Pourinformation..."##########,
    "page 331"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_188,
    r##########"10 Array already dimensioned (tableau deja dimensionne) Un des tableaux d'une instruction DIM a deja ete defini.
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_189,
    r##########"14 142 (1 28+ 14) Etatducanal nonvalable.
...
26 154 (1 28+26) Fin de fichierlogicielle. Si AMSDOS adejarapporteuneerreur,lebit7aprislavaleur 1, decalantcelledeDERR de 128. Lesautresvaleursrapporteespar DERR proviennentducontroleurdeladisquette,lebit 6etanttoujours sur 1. Le bit7indiquesi AMSDOS a rapporte l'erreurou non (voir ci- dessus). Voici la significationdechacun des bits Bit Signification Adresse manquante. Ecriture impossible. Disquette protegee. 1"##########,
    "page 337"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_190,
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_191,
    r##########"1000 aissdoserr=fDERR AND fc7F):REM bit 7 force a
...
240 R c6=c5 5r C6=c4 OR c6=c3 OR c6«c2 OR c6=cl THEN 330"##########,
    "page 367"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_197,
    r##########"288 LOCATE 12, f 5:PRINT x;o$ >
...
430 «*=LEF , T*(«*,7)
440 FOR x=l TO LEN(fflt)"##########,
    "page 368"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_198,
    r##########"470 iBANKFIND,3rX,is$,0,Ustrec
480 IF rX<0 THEN GOTO 420
490 !BANKREAD,3rX,g*
500 PRINT g* f
510 !BANKFlND,3rX,n$,rX+l,lastrec
520 GOTO 480 :hapitre8 Page8 Bank Manager : complementd'informations"##########,
    "page 368"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_199,
    r##########"21 = 2 = 2 = 2(2°)
22 = 4 = 2x2 = 2(2')
23 = 8 = 2x2x2 = 2(2 2 )"##########,
    "page 377"
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_200,
    r##########"10 1010 A
11 1011 B C
12 1100 D
13 1101
14 1110 E mi
15 F
16 10000 10 Un nombre a 8 bits peutetredecompose en deux nombresde4 bits(appeles nibblesen anglais,cequ'on peut traduire parpetite bouchee...). Danscelivre, lesnombreshexadecimauxsontdesignesparlesymbole&, &D6 parexem- ple,et serventauxprogrammeursqui utilisent le langage assembleur,a mi-cheminentre le langage machineet le BASIC. Pourconverterde I'hexadecimat, vousdevezfaireattentiona multiplierle premierchiffire par 16et lui ajouterledeuxieme. Ainsi &D6donne (I3xl6)+6=214 et non pas 13 et 6 ou 136,comme on serait tente de lefaire. C'est le meme procede que celui du systeme decimal, a ceci pres qu'il est plus facilede multiplier par 10que par 16 ! Chapitre9 Psge12 Avosheuresdeloisii.."##########,
    "page 380"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_201,
    r##########"10 FOR n=32 to 255
20 PRINT CHR*(n);
30 NEXT ...n'acertainement plusde secretspour vous. Decortiquons-lemaintenant Nousconstatonstoutd'abordqu'aulieud'ordonnerPRINT« abcdefghi]klmn...etc», nousavonsentre PRINTCHR${n). netantunerepresentationpratiquede«variable». Une variable est un element d'information qui « varie» selon les instructions du pro- gramme. (Lechoixde n pour variableest tout a fait arbitraire, nousaurions pu prendre n'importequellecombinaison de lettres, pourvu qu'elle soit differented'un mot cle). Comment reconnaitre une variable? Lechiffre5estfixe,ilestcomprisentre4et6 ; il n'estdonepasunevariable. Lecaractere n est egalement fixe,c'est une Iettrede Palphabet. Avosheuresdeloisir..-. Chapitre9 Page 15"##########,
    "page 383"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_202,
    r##########"10 INPUT "Aujourd'hui nous sammes le"ijour
20 INPUT "Buel est le numero du mois";mois
30 IF jour=25 AND mais=12 THEN 50
40 CLSsSOTO IB
50 PRINT"Joyeux Noel ! OR opereegalement parbits,donnant1 danstouslescasou lesdeux bitsdesarguments different de 0, auquel cas le resultat est egal a 0. Avec les memes nombres que dans AND Pexemple : PRINT 1000 OR 10 1002 En binaire: 1010 111101000 1 Resultat: 1111101010 Dans un programme"##########,
    "page 386"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_203,
    r##########"10 CLS
20 INPUT "Quel est le nunero du mois"sffloi5
38 If mais"12 OR mais=l OR mois=2 THEN 50
40 SOTO 10
50 PRINT"Nous devrions etre en Hiver !" Avosheuresdeloisir... Chapitre9 Page 19"##########,
    "page 386"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_204,
    r##########"10 CLS
20 INPUT "Quel est le numero du mois";(«ois
32 IF NOT Uoi<s*i OR mais=7 OR mois=8) THEN 50
40 GOTO 10
50 PRINT"Nou5 ne pouvons etre en Ete !" On peutaussimelangerautantd'operateurslogiquesqu'oniedesire(danslalimited'une ligne) pourdonner, parexemple :"##########,
    "page 387"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_205,
    r##########"10 INPUT "Aujourd'hui nous soames le";jour
...
70 PRINT (mois=12 OR mois=i! Si vous lancez Ie programme avec 29 pour lejour et 2 pour le mois, vous obtenez la reponsede la ligne 50 et les valeurs produitespar lesexpressionsdes Iignes 60 et 70. Pour finir, XOR (OU eXcIusif) donne un resultat vrai si les deux arguments sont differents. Resumons par un tableau susceptible de donner une idee plusclairede la situation. Ce typede representation est appele tablede verite d'une fonction. ARGUMENTA 1010 ARGUMENT B 0110 AND Resultat (et) 0010 OR Resultat (ou) 1110 XOR Resultat (ou exclusif) 1 100 Chapitre9 Page20 A vosheuresdeloisir.."##########,
    "page 387"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_206,
    r##########"10 MODE
20 POR n=0 10 7
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_208,
    r##########"10 MODE l;n=<14;x=RND»400
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_209,
    r##########"10 READ a,b,c
20 PRINT"les nombres sont";a; "et";b ; "et";c
38 DATA 12, 14,21 run
118 INPUT "fcntres 3 nombres separes par une virqule";a,b,c i.< 20 PRINT "les notnbres sent";a; "et }b; "et"5c ' run i* Des virgules separent lesdifferentselementsd'unecommande DATA, tout eommepour commande INPUT. la Outre des valeurs numeriques, les commandes DATA peuvent contenirdes constantes alphanumeriques"##########,
    "page 398"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_210,
    r##########"10 DIM a*(i0)
20 FOR i=0 TO 9
30 READ a*<i)
40 NEIVT
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_211,
    r##########"18 READ a$
20 WHILE a$0"*"
30 PRINT at
40 READ a$
...
80 DATA t run Lachainede ia Iigne 60comportedesvirgulesentramant Ielectureet l'affichagedecha- que partie. Parcontre, la chainede la ligne 70 estdelimitee pardes guillemets, et sera done affichee comme un tout. READ L'exemple ci-dessus montre que les donnees peuvent occuper plusieurs lignes. traiteleslignesdehauten basdansl'ordredesnumerosdeligne(60,70,80,etc.). Par DATA ailleurs, les instructions peuvent se trouver n'importe ou dans Ie programme avant ou apres Ia commande READ qui extrait les informations. Si un programmecontientplusieurscommandesREAD, la secondereprend laou la pre- miere s'arrete"##########,
    "page 399"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_212,
    r##########"10 DATA 123,456,789,321,654,2343
20 FOR i=l TO 5'
30 READ nomb
40 total=total+nomb
50 NEXT
60 READ tota!2
70 IF total=toU12 THEN PRlNT"les donnees sont just«" ELSE PRINT" t1 y a une erreur dans les donnees" run Essayezde modifier Ia ligne 10 en introduisant une erreurdans l'un des cinq premiers nombres, puisiancezleprogramme.Cettemethoded'insertion,a lafind'unecommande DATA,d'unevaleursupplementalegaiea la sommedetouteslesautresvaleursconsti- tue un bon moyen de detection d'eventueiles erreurs, surtout lorsque les lignes DATA sontnombreuses. Cettemethodes'appelle sommedecontrole (checksum). Si un programme faitappel a desdonnees mixtes(chaineset nombres), ilest possiblede lescombinerdans lesinstructions DATA et READ, a condition que leselements soient luscorrectement. Parexemple, si DATA contenaitdessequencesdedeux nombressuivis d'unechaine, seul l'emploi d'unecommande READ suiviededeuxvariablesnumeriques et d'unechaine seraitjustifie : Chapitre9 Page32 A yosh«ur»d©lowr. ."##########,
    "page 399"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_213,
    r##########"10 DIM a<5) ,b(5) ,p$(5)
20 FOR i=l TO 5
30 READ a(i),bU) ,p*<i)
40 NEXT
...
80 NEXT Vouspouvez, pourchanger, separer lesdifferents typesdedonnees"##########,
    "page 400"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_214,
    r##########"10 DIM a<5) ,b!5) ,p$<5)
20 FOR i=l TO 5
30 READ aft ,b(i )
40 NEXT
...
120 NEXT Silaboucle FOR de la ligne20sechangeen"##########,
    "page 400"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_215,
    r##########"15 RESTORE 80
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_216,
    r##########"1000 REM section de dessin sur ecran
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_217,
    r##########"2000 REM DATA pour 1'ecran 1
2010 DATA 200,190,244,244,210 ...etc"##########,
    "page 401"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_218,
    r##########"2500 REM DATA paur 1'ecran 2
2510 DATA 100,103,245,243,251 ...etc"##########,
    "page 401"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_219,
    r##########"10 FOR i=l TO 3
20 RESTORE 100
30 READ note
40 WHILE note <>-t . •
...
130 DATA 142,142,106,119,127,-1 run ;hapitre9 Page34 Avosheuresdeloisir."##########,
    "page 401"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_220,
    r##########"32 peuventegalement etre utilisees,afind'indiquerqu'un son produit sur un canal a ren- dezvousavecunautrecanal(A, Bet C respectivement).Qu'entendons-nousparrendez- vous?C'est tressimple : lessonsquenousavons fabriquesjusqu'a presentetaientimme- diatementjoues sur lecanal indique. Essayezdonecequi suit SOUND 1,142,2000 SOUND 1,90,200 Chapitre9 Page36 Avosheuresdeloisir..."##########,
    "page 403"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_221,
    r##########"10 FOR a=l TO 8
20 BOUND 1,1001a, 2U
30 NEXT
40 PR NT"bonjour" I run Vous constatezque le mot" bonjour "nes'affichequ'au bout d'un certain temps,apres execution des trotspremiers sons. Ceretard tient au fait que 1'execution du programme ne peut continuer tantqu'une place nes'est pas libereedans la file. Le BASIC possede un mecanisme d'interruption assez similaire a celui qu'utilisent les commandesAFTER, EVERY ou ON BREAK GOSUB. fl donneaccesa unsous-pro- gramme d'emission sonore qui n'est appele que lorsqu'une place se libere dans la file demandee. En voici un exemple :"##########,
    "page 411"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_222,
    r##########"10 a=
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_226,
    r##########"10 REM liqne 190 donne la clef de SOL
...
470 n2*=" "+n2$
480 nd27.=(l+INSTR (gamine*, LGWER*(n2$) ) ) 12"##########,
    "pages 413, 414"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_227,
    r##########"510 ON 3Q(2) SOSUB 380
520 RETURN
530 n2*=n24+FNm*(ca2*,ca2X)
540 ca27.=ca27.tl
550 GOTO 480 run ::,;•:r.f-.»fift. h.;: -.:. ,- /:;«:/? Si nous parlions graphiques ? La partiequisuitestconsacreeaux fonctionsgraphiquesde1'AMSTRAD664,dontnous alions, a partir d'un premierexemple, decouvrir tour a tour les pointsessentiels. Nousalionscommencer par partager Pecran en deux : une fenetrede texte(tigne40)et une fenetre graphique (ligne 30). Puis nous choisirons tin MODE, ainsi que deux cou- leursclignotantes (ligne 20). Avoaheuresdeknsir... Cbapitre9 Page47"##########,
    "page 414"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_228,
    r##########"10 REM MASK et TAS dans les fenetres
...
80 MOVE 0,2:FILL 3 La ligne 80 pose le curseur graphique a Pinterieur d'une des moities du carre, qu'elle colore au moyen de i'encre 3. Les limites de cecoioriage sont le bord de la fenetre (qui estaussiceluidenotrecarre)et toutelementgraphiquetraceparlestylographiqueutilise (le 3)ou pour lequel on a indique la memeencrequecelledu remplissage (la numero 3 egalement), Executezle nouveau programme : Verifiez ce qui a ete dit a propos des limites du coioriage, en ecrivant la ligne 70."##########,
    "page 415"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_229,
    r##########"78 GRAPHICS PEN 1 run Remarquezbien que si I'encrede la diagonalen'etaitpasla memequecelleducoioriage, c'estlecarretoutentierquiseraitcolorie,cequevouspouvezverifieren remplacant FILL 3par FILL 1 dans la ligne 80. Revenezensuitea I'etatinitial (FILL3). Dessinons maintenant un cadre
100 MOVE 20,20
110 DRAW 180,20 „/* 120 DRAW 180,180 v " 130 DRAW 20, 180
140 DRAW 20,20 run Chapitre9 Page48 Atottutoxesdeloisir..."##########,
    "page 415"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_230,
    r##########"90 MASK run Mais pourquoi ce programme ne respecte-t'il pas la sequence choisie lorsqu'il trace un c p o r i e n mi ? e T r o p u o t in s t im d p es le l m i e gn n e t s p q a u r i c l e e q c u o e mp ! o e s c e o n i t n . es O t n tr p a e c u e t d c e o u n x to fo u i r s n : e e r n ce ta p n r t o q b u l e em d e er c ni o e m r m p e oi c n e t ci et
115 MOVE 160,22
125 MOVE 178,180 f 135 MOVE 28,178 run On obtient bien l'effet desire, mais il y a beaucoup plus simple. Si Ton ajoute a la com- mande MASK unsecond parametre " ,0",l'ordinateurnetracepaslepremierpointde 90 chaqueligne. Corrigeons alors la ligne :"##########,
    "page 416"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_231,
...
190 TAGOFF run mttSmminSu-•: nnitav -. Bien que les messages emis par le BASIC s'affichent sur la fenetre de texte sans tenir compte de l'indicateur TAG/TAGOFF, il est bon des'habituer a annuler la commande TAG desque Ton n'a plus besoin d'elle. Chapitre9 -Page50 A voshears*d»toisir."##########,
    "page 417"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_232,
    r##########"150 GRAPHICS PEN t,0 run : ...nousauronsdenouveau lepapieropaque, tandisque
...
180 200. comprise entre les lignes a Avosheuresdeloisir... Chapitre9 Page53"##########,
    "page 420"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_235,
    r##########"10 REM animation par les couleurs
...
200 NEXT i,p
210 GOTO 160
220 INK 1,26 run Plans colores L'exempleprecedent nousamontrecommentanimeral'aidedeschangementsdecouieur desgraphiques tracesaveclesencres I, 2et8. On peut,avec les memesencreseten utili- sant lescouleursdifferemment,creeruneffetcompletementdifferentappele« planscolo- res». En voici un exemple :"##########,
    "page 421"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_236,
    r##########"10 REM Montagnes
20 DEFINT a-z
30 INK 0,1: INK 1,26 .
40 INK 2,6:1NK 3,6
...
220 x2-(<60B-x)*2>MOD 640: hi =RND* 10: hr=50*SIN (x"##########,
    "pages 421, 422"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_237,
    r##########"250 IF (T£ST(x2-2, 115+hl-t2> AND 8>=8 THEN 380
260 IF TIME-t!<30 THEN 260
270 FRAMEst!=TIME
280 GRAPHICS PEN 7,1: MOVE x, 100+hr, ,2; PRINT pr$;
290 GRAPHICS PEN 13,1: MOVE x2, 15+hl 2:PR1 NT pi*;"##########,
    "page 422"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_238,
    r##########"300 NEXT
310 GOTO 210
320 MOVE ex 100 ,
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_240,
    r##########"100 DIM command*(22)
...
570 DRAW tempxx, teinpyy: DRAW tempx,te«py «U20 : Avosheuresdeloisir... Chapitre9 Page57"##########,
    "pages 423, 424"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_241,
    r##########"580 GOSUB 630
...
670 RETURN
680 ' curseur trace & Hfact"##########,
    "page 425"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_242,
    r##########"670 IF f lag=5 THEN RETURN
700 MASK 255,1
...
1000 IF INKEY(8X>-1 OR INKEY(74)<>-1 THEN tx=-16 Chapitre9 Page58 Av«sheuresdeloisir."##########,
    "page 425"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_243,
    r##########"1040 j$=INKEY$:i*=UPPER*(j«) „„
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_244,
    r##########"1150 GRAPHICS PEN pnsPEN II,pn
1160 tx=0:ty=0:BORDER pn <gn) I RETURN
1170 IF tx<0 THEN ch=ABS(ch+255> MOD 256"##########,
    "page 426"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_245,
    r##########"1160 IF ty<0 THEN ch=A8S (ch+246) MOD 256
...
1400 RETURN Avos hemes de loiar... Chapitre9 Page59"##########,
    "page 426"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_246,
    r##########"1440 tempx+x: te(tpy=y:+"lag=2 .?
1450 x=0:y=0
1460 RETURN j -.*:
1470 IF norx= l THEN 1500 -.-Si"##########,
    "page 427"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_247,
    r##########"1500 x=tempx: y=tewpy lag=0 : f
1510 RETURN
1520 ' F ycil
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_248,
    r##########"1690 RETURN n:j
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_249,
    r##########"1900 RETURN
...
1980 RETURN
1990 FOR i=0 TO 3:INK i , pn (i ): NEXT i BORDER pn(4)"##########,
    "page 428"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_250,
    r##########"2010 CLSjRETURN 2B20 ' A
2030 IF flatpi THEN 2870"##########,
    "page 428"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_251,
    r##########"2050 undraw=l:Hag=6i narx= l : •oved»l
2060 RETURN
2070 flsg=0
2080 RETURN
2090 ' N
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_252,
    r##########"2218 menu=menu MOD 2+1
...
2610 BORDER pn (4) pn= GRAPH ICS PEN pn"##########,
    "pages 428, 429"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_253,
    r##########"2620 RETURN
...
2750 DATA "CBFT3LIANEXM" , " 1234RSM""##########,
    "pages 429, 430"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_254,
    r##########"10 'BUSTOUT by ALEXANDER MARTIN
...
110 '
120 '
130 MOVE 30,32:DRAWR 0,400, MOVE 610,32:DRAWR 0,400,1"##########,
    "page 469"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_255,
    r##########"140 PEN 38LOCATE 3, UPRINT STR ING*<36, 143!
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_256,
    r##########"260 xa=l ya-1 IF INT(RND*2)=1 THEN xa=-xa : :
290 PEN IsGQSUB 250
300 ORIGIN 0,400 •>«« '-'
310 x=bx+4:y=il:xt=x:yl=y
320 ' ''''• -
330 '
340 xl=x+xaiy l=y+ya Etpourquelquesprogrammesdeplus... Annexe3 Page 1"##########,
    "page 469"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_257,
    r##########"370 IF yl=24 AND xl>bx+l AND xl<bx+6 THEN ya*-yat y l=y1-2:SOU ND 130,44,8,7,l,l:a=<(x>bx<-5>OR(x<bx+2)):IF a=-l THEN xa=xat a: x l =x l+xa:y 1=y1+
380 IF y 1 =25 THEN LOCATE x,y.PRINT " " I GOTO 580
390 GOSUB 250
400 =TESTU16*xl)~l,-<16*yl)-l) t
410 IF t<>0 THEN ya=-ya:xz=xl:yz=ylsyl=yl+yasGOSUB 590: IF t*"##########,
    "page 470"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_258,
    r##########"420 IF t=3 THEN score=score+20:GOSU8 660
...
690 LOCATE 25: PRINT SPACE* (40) ;: RETURN i , Annexe3 Page-.2 Elpourquelqueaprogrammesdeplus..."##########,
    "page 470"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_259,
    r##########"10 ' BOMBARDIER
...
110 niv=niv+10
120 LOCATE 1 , 15: PRINT CHRt tl8! ; :L0CATE 1, IS: INPUT "Vitesse :"##########,
    "page 471"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_260,
    r##########"130 IF vit>108 OR vit<0 GOTO 120
140 '
150 ' Intseubles
160 '
...
510 PEN 2:L0CATE 24;PR INTi PRINT"APPUYEZ SUR UNE TOUCHE PDU"##########,
    "pages 471, 472"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_261,
    r##########"520 a$=INK£Y$: IF a*="" THEN GOTO 520
530 RETURN
540 '
550 ' collision
560 '
...
600 IF score>hi5core THEN hiscore=scoresLOCATE i,8:PRINT"NEI LLEUR SCORE !"j"##########,
    "pages 472, 473"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_262,
    r##########"640 '
...
690 NEXT
700 LOCATE 6,25:PRINT score; :chute=0:a=x :b=y:60T0 230 Etpourquelquesprogrammesdeplus... Annexe3 Page 5"##########,
    "page 473"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_263,
    r##########"10 'PING PONG by DAVID RADISIC
...
270 raquette**" "+CHR$(8I +CHR*(10)+" ! !"##########,
    "page 474"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_264,
    r##########"290 balle*=CHR*(24B)
300 PEN 3
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_265,
    r##########"670 LOCATE x (i ),yli ):PRINT raquette*;
680 NEXT
698 PEN 1
700 RETURN
...
830 MODE IsRETURN Etpourquelquesprogrammesdeplus... Annexe3 Page?"##########,
    "page 475"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_266,
    r##########"10 "ESCRIME ELECTRIBUE par ALEXANDER MARTIN
20 'copyright <c> AMSOFT 1985
30 '
40 DEFINT a-z
50 MODE
...
410 IF jl AND 16 THEN j lsa=j isa-1 : IF jlsa*~l THEN AFTER 15 G QSUB 770 ** Annexe3 Page 8 Etpourquelquesprogrammesdeplus."##########,
    "page 476"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_267,
    r##########"428 IF j2 AND 16 THEN j2sa=j2sa-l : IF j2sa»-l THEN AFTER 15 9 0SU8 770
...
510 IF INKEY (10)=0 THEN j 2sa=j2sa-l : IF j2sa=-l THEN AFTER 1"##########,
    "page 477"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_268,
    r##########"520 IF j lsa THEN jldir=0
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_269,
    r##########"710 '
...
750 '
768 '
778 jwpe=(j lwp=j2wp) : IF jlsa AND NOT (j2sa) AND jwpe THEN jl sc=jlsc+USQUND 132, 120, 10, 0, 1 , 0: PR INT # 1 , a* (j t sc ) ; : IF jlsc="##########,
    "page 477"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_270,
    r##########"780 IF j2sa AND NOT (jlsa) AND jwpe THEN j2sc=j 2sc+l ; SOUND 1 32,100,10,0,l,0:PRiNT #2, a*(j2sc) IF j2sc=9 THEN 860 ; :
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_271,
    r##########"1070 taille*LEN(a$(n))
...
1250 '
1260 '
1270 INK 8,12!lNK 1,2: INK 2,6:INK 3,13:INK 4,20sINK 5,1: INK Annexe3 Page 10 Etpourquelquesprogrammesdeplus."##########,
    "page 478"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_272,
    r##########"1288 WINDOW #3,3,3,6,25: WINDOW 15,18,18,6,25
1290 WINDOW #1,3,5, l,5iWINDQW #2, 16, 18, 1 , 5:WINDOW #7,1,28,1, 5:PAPER #7,3
1380 CLS:CLS #7: PRINT #1 , a* (0) ; PRINT #2,a!(B> j :j lsc=fl:j2sc= 0:j lwp=Ssj2wp=24sjldir=t:j2dir=l"##########,
    "page 479"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_273,
    r##########"1310 GOSUB 570;GOSUB 620
...
1630 RETURN Etpourquelquesprogrammesdeplus. . Annexe3 Page 1"##########,
    "page 479"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_274,
    r##########"10 ' database 20
30 ' Dfl 12/12/B4
40 ' Initialisation
50 CLEAR
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_275,
    r##########"240 'Le libelle des champs est ds le ler enreg.
250 RESTORE 3620 lit les en-tetes des champs
260 READ Heldlt(B) ,Held2*(0; Held3$(0!
270 READ Held4*(0l , Held5*(0; f i el d6S (0)"##########,
    "page 480"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_276,
    r##########"260 Ecran '
...
800 '
840 title$="Ajout d'un enrg" ! 60SUB 2828 ' en-tete"##########,
    "pages 480, 481"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_277,
    r##########"820 IF nextblank > recnum THEN LOCATE 14,8 t PRINT "Database plein" GOTO 2750 :
...
1070 field3*(i-i)=field3*(i)!field4*(i-l ! =field4$ (i)"##########,
    "pages 481, 482"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_278,
    r##########"1060 field5*<i-l>=fieid5$U>ifield6$(i-l)=field6*(i)
1090 NEXT
...
1130 RETURN
1140 t
1150 ' S0US-PR06RAME: tri"##########,
    "page 482"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_279,
    r##########"1170 title*="Tri enreg." ; SOSUB 2820 ' en-tete
...
1280 WHILE HagX=l
1290 flag7.=
1300 FOR s37.=l TO s2X Annexe3 Page 1 Et pourquelquesprogrammesdeplus..."##########,
    "page 482"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_280,
    r##########"1338 NEXT s37.
1340 WEND
1350 WEND
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_281,
    r##########"1460 5l*»=field3*(s3X):field3*(s3X)=Ueld3*(s4X):Held3*(54XJ - si*
1470 sl$=field4*(s3X):Held4*(s3X)=field4*(s4X)!*ield4*(s4X> - si*"##########,
    "page 483"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_282,
    r##########"1450 sl4=Held5*(537,):Held5*(s3X)=Held5*(s4X):field5*(s47.) = si*
...
2470 PRINT : PRINT "en-tete 3: " i + ieldSt < 0!"##########,
    "pages 483, 484, 485"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_283,
    r##########"2460 INPUT "Change em", (it
...
3450 ' -
3460 DATA "Wi 11 arcs: 7471 ", "Stevens:6216" , "Soames :5807", "Smi t h :2201" 4M Etpourquelquesprogrammesdeplus... Annexe3 Page 19"##########,
    "pages 485, 486, 487"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_284,
    r##########"3470 DATA "Nesbit 2207" "Marks 2022", "Upton 1091", "Gree : , s j :8087" n
...
3620 DATA Nom, Rue, Vi 1 1 e, Pays, Code Postal , Tel .No ftB *• » i Etpourquelquesprogrammesdeplus. Annexe3 Page 20 ."##########,
    "page 488"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_285,
    r##########"10 'ARSENE LUPIN by DAVID RADISIC
...
260 LOCATE 7,5;PR1NT"REJ0UER""##########,
    "page 489"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_286,
    r##########"290 IF i*="N" THEN MODE 2:PEN 1 STOP
300 RUN
...
470 SYMBOL 248,8,24,88,56,24,24,3,8"##########,
    "pages 489, 490"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_287,
    r##########"460 SYMBOL 249,8,24,24,56,88,24,8,8
...
898 PAPER PEN BiPRINT objtj" Obstacles"! PEN liPAPE"##########,
    "pages 490, 491"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_288,
    r##########"900 PEN PRINT chien*:" Lb chien" 1
...
1800 IF dir=1 THEN xp=6: yp=maxy(rm) Page 24 Etpourquelquesprogrammesdeplus..."##########,
    "pages 491, 492"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_289,
    r##########"1840 RETURN
...
1910 LOCATE 3,3:PRINT"vou5 vous en tlrez f ; „"##########,
    "page 493"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_290,
    r##########"1940 PRINT USING " ##" vol
...
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_291,
    r##########"2020 IF i=gems(rm> THEN 2050
...
2640 GOTO 1510
2650 PRINT-'SNAP' "; famexe3 Page 26 Etpourquelquesprogrammesdeplus.."##########,
    "pages 493, 494"
);
basic_test!(
    test_amstrad_cpc6128_manuel_de_lutilisateur_1985_amsoft_fr_text_listing_292,
    r##########"2660 *ort=l:RETURN
2670 DATA ENTREE
...
3170 DATA END Si cesjeux vous ont plu, vous pouvez vousjoindre au Club des utilisateurs AMSTRAD. Entre autres privileges et avantages, vous recevrez gratuite- AMSTRAD ment le mensuel quipublicprogrammes dejeu, utilitaires,fonc- tions speciales, bulletins departicipation a des concours et des informations de derniere minute. i 1 1 •3* Annexe3 Page 28 Etpourqueiquesprogrammesdeplus..."##########,
    "pages 495, 496"
);
