// Tests for BASIC listings from AMSOFT_AMSTRAD_BASIC_Initiation_au_Basic_AMSTRAD_Partie1_SOFT411[OCR]-1.pdf
...
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_001, r##########"10 REM drawing a house (dessiner une maison)
20 MODE 0
30 CLS
40 REM ** start ** (début)
50 Border 12
...
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_002, r##########"10 Rem 3D Bar Chart (histogramme)
...
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_005, r##########"10 REM deco
20 MODE 0
30 CLS
40 REM ** START **
...
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_006, r##########"10 REM mansion (maison)
20 MODE 0
30 CLS
40 REM ** start ** (debut)
50 BORDER 12 (bord)
...
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_008, r##########"860 MOVE 330,203 GOSUB 900 87G MOVE 356,203 GOS-B 900 88U END (fin) 89Cl REM subroutine forsquare (sous-programmaticwipourcarre)
900 DRAMR 0,size,9 L»"##########, "page 70");
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_009, r##########"91 iLl-Ill DRAMR size,0
92 L W i 0RAwR 0,-si ZE 931"* DRAMR -size, -uó 94O RETURN"##########, "page 70");
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_010, r##########"74 Franchissez-le Refermez le portail Else (aut rement) autrement dirigez vous vers la Next (suivante) maison suivante."##########, "page 76");
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_011, r##########"20 REMEU/Dave Atherton
30 MODE1
35 INKO U1 MU _0CA" :PRINT"SOUND DEMO" 50\_OCAf PRINT"1. Explosion""##########, "page 90");
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_012, r##########"180 IF a=1'HEN GOS..B 280
...
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_015, r##########"10 REM **BLACKJACK**
20 REM
30 REM **STARTUP**
40 MODE 1:BORDER 4
50 INK 0,17:INK1,0
...
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_016, r##########"10 cr$=CHR$(13)
20 REM Simon
30 REM **** 1NsTRucT1oNs ****
...
basic_test!(test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_017, r##########"108 au-dessusduclaviernumeriqueetsontsignalccsdelafaçonsuivante'i
