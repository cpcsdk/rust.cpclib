...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_001,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_002,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_003,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_004,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_005,
    r##########"10 REM deco
20 MODE 0
30 CLS
40 REM ** START **
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_006,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_007,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_008,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_009,
    r##########"91 iLl-Ill DRAMR size,0
92 L W i 0RAwR 0,-si ZE 931"* DRAMR -size, -uó 94O RETURN"##########,
    "page 70"
);
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_010,
    r##########"74 Franchissez-le Refermez le portail Else (aut rement) autrement dirigez vous vers la Next (suivante) maison suivante."##########,
    "page 76"
);
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_011,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_012,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_013,
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_014,
    r##########"10 REM Garden
20 MODE 1
30 INK 0,0:BORDER 0
40 INK 1,26
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_015,
    r##########"10 REM **BLACKJACK**
20 REM
30 REM **STARTUP**
40 MODE 1:BORDER 4
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_016,
    r##########"10 cr$=CHR$(13)
20 REM Simon
30 REM **** 1NsTRucT1oNs ****
...
basic_test!(
    test_amsoft_amstrad_basic_initiation_au_basic_amstrad_partie1_soft411_ocr__1_listing_017,
