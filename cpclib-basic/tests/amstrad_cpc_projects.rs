...
fn test_sectfgt_bas() {
    let result =
        parse_basic_file("tests/amstrad-cpc-projects-master/games/sector-fight/sectfgt.bas");
    match result {
...
fn test_all_files_summary() {
    let files = vec![
        (
            "bounce.bas",
            "tests/amstrad-cpc-projects-master/graphics/bounce.bas"
        ),
        (
            "checker.bas",
            "tests/amstrad-cpc-projects-master/graphics/checker.bas"
        ),
        (
            "diagfld.bas",
            "tests/amstrad-cpc-projects-master/graphics/diagfld.bas"
        ),
        (
            "lisscycl.bas",
            "tests/amstrad-cpc-projects-master/graphics/lisscycl.bas"
        ),
        (
            "plasma.bas",
            "tests/amstrad-cpc-projects-master/graphics/plasma.bas"
        ),
        (
            "spiral.bas",
            "tests/amstrad-cpc-projects-master/graphics/spiral.bas"
        ),
        (
            "tunnel.bas",
            "tests/amstrad-cpc-projects-master/graphics/tunnel.bas"
        ),
        (
            "webchaos.bas",
            "tests/amstrad-cpc-projects-master/graphics/webchaos.bas"
        ),
        (
            "sectfgt.bas",
            "tests/amstrad-cpc-projects-master/games/sector-fight/sectfgt.bas"
        ),
    ];
...
fn test_all_roundtrip() {
    ...
    if !failed_files.is_empty() {
        ...
        panic!(
            "{} out of {} files failed round-trip test",
            failed_files.len(),
            total_files
        );
    }
...
fn test_roundtrip_sectfgt() {
    match test_roundtrip_file("tests/amstrad-cpc-projects-master/games/sector-fight/sectfgt.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ sectfgt.bas round-trip: {}/{} lines verified, {} skipped",
            ...
            if testable > 0 {
                ...
                assert!(
                    percent >= 95.0,
                    "Round-trip success rate too low: {:.1}%",
                    percent
                );
            }
        },
...
fn test_roundtrip_bounce() {
    match test_roundtrip_file("tests/amstrad-cpc-projects-master/graphics/bounce.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ bounce.bas round-trip: {}/{} lines verified, {} skipped",
                successful, total, skipped
            );
        },
        Err(e) => panic!("{}", e)
...
fn test_roundtrip_plasma() {
    match test_roundtrip_file("tests/amstrad-cpc-projects-master/graphics/plasma.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ plasma.bas round-trip: {}/{} lines verified, {} skipped",
                successful, total, skipped
            );
        },
        Err(e) => panic!("{}", e)
...
fn test_roundtrip_starfield() {
    match test_roundtrip_file("tests/samples/starfield.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ starfield.bas round-trip: {}/{} lines verified, {} skipped",
                successful, total, skipped
            );
        },
        Err(e) => panic!("{}", e)
...
fn test_roundtrip_sine_scroller() {
    match test_roundtrip_file("tests/samples/sine_scroller.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ sine_scroller.bas round-trip: {}/{} lines verified, {} skipped",
                successful, total, skipped
            );
        },
        Err(e) => panic!("{}", e)
...
fn test_roundtrip_mandelbrot() {
    match test_roundtrip_file("tests/samples/mandelbrot.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ mandelbrot.bas round-trip: {}/{} lines verified, {} skipped",
                successful, total, skipped
            );
        },
        Err(e) => panic!("{}", e)
...
fn test_roundtrip_game_of_life() {
    match test_roundtrip_file("tests/samples/game_of_life.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ game_of_life.bas round-trip: {}/{} lines verified, {} skipped",
                successful, total, skipped
            );
        },
        Err(e) => panic!("{}", e)
...
fn test_roundtrip_color_bars() {
    match test_roundtrip_file("tests/samples/color_bars.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ color_bars.bas round-trip: {}/{} lines verified, {} skipped",
                successful, total, skipped
            );
        },
        Err(e) => panic!("{}", e)
...
fn test_roundtrip_bouncing_ball() {
    match test_roundtrip_file("tests/samples/bouncing_ball.bas") {
        Ok((total, successful, skipped)) => {
            println!(
                "✓ bouncing_ball.bas round-trip: {}/{} lines verified, {} skipped",
                successful, total, skipped
            );
        },
        Err(e) => panic!("{}", e)
