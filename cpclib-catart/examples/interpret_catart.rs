...
30 INK 1, 4, 4
40 INK 2, 13, 13
50 INK 3, 22, 22:PAPER 1
60 WINDOW 2, 3, 14, 18:CLS
70 WINDOW 19, 20, 14, 18:CLS
80 WINDOW 3, 19, 13, 13:CLS
90 WINDOW 4, 18, 12, 12:CLS
100 WINDOW 10, 12, 10, 10:CLS
110 WINDOW 5, 17, 6, 6:CLS
120 WINDOW 7, 9, 20, 22:CLS
130 WINDOW 13, 15, 20, 22:CLS
140 WINDOW 4, 10, 23, 24:CLS
150 WINDOW 12, 18, 23, 24:CLS
160 PAPER 2
170 WINDOW 4, 18, 13, 13:CLS
180 WINDOW 5, 17, 11, 11:CLS
190 WINDOW 9, 13, 2, 3:CLS
200 WINDOW 1, 21, 15, 15:CLS
210 WINDOW 1, 21, 17, 17:CLS
220 WINDOW 7, 9, 18, 19:CLS
230 WINDOW 13, 15, 18, 19:CLS
240 WINDOW 6, 16, 21, 21:CLS
250 PAPER 0
260 WINDOW 5, 17, 15, 17:CLS
270 PAPER 3
280 WINDOW 7, 15, 4, 9:CLS
290 WINDOW 6, 16, 11, 17:CLS
300 WINDOW 7, 9, 23, 23:CLS
310 WINDOW 13, 15, 23, 23:CLS
320 PAPER 0
330 WINDOW 9, 10, 5, 6:CLS
340 WINDOW 12, 13, 5, 6:CLS
350 PAPER 2
360 WINDOW 7, 15, 12, 12:CLS
370 WINDOW 8, 14, 14, 14:CLS
380 WINDOW 7, 15, 16, 16:CLS
390 WINDOW 23, 38, 4, 8:CLS
400 PAPER 3
410 WINDOW 23, 35, 5, 7:CLS
420 PAPER 1
430 WINDOW 24, 24, 5, 7:CLS
440 WINDOW 28, 28, 5, 8:CLS
450 WINDOW 34, 34, 4, 8:CLS
460 WINDOW 36, 36, 5, 7:CLS
470 WINDOW 38, 38, 4, 8:CLS
480 PAPER 0
490 WINDOW 37, 38, 5, 7:CLS
500 WINDOW 25, 26, 5, 7:CLS
510 WINDOW 29, 32, 5, 8:CLS
520 WINDOW 0, 39, 0, 25
530 LOCATE 12, 22:PRINT " ";
540 LOCATE 10, 3:PRINT " ";
550 LOCATE 14, 3:PRINT " ";:PAPER 3
560 LOCATE 13, 3:PRINT " ";:PAPER 1
570 LOCATE 27, 5:PRINT " ";
580 LOCATE 31, 5:PRINT " ";
590 LOCATE 27, 9:PRINT " ";:PAPER 0
600 LOCATE 28, 16:PRINT "RUN";:PRINT CHR$(34);
610 LOCATE 32, 16:PRINT "CRTC";
