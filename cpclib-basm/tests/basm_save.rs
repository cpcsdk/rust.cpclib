...
fn bankset_check_save() {
    ...
    let args =
        args_parser.get_matches_from(&["basm", "-I", "tests/asm/", "good_bankset.asm"]);
	...
	assert_eq!(
		&mem[0x10000..(0x10000+4)],
		&data_1_0
	);

	assert_eq!(
		&mem[0x14000..(0x14000+4)],
		&data_1_1
	);

	assert_eq!(
		&mem[0x18000..(0x18000+4)],
		&data_1_2
	);

	assert_eq!(
		&mem[0x1c000..(0x1c000+4)],
		&data_1_3
	);
	...
	assert_eq!(
		&std::fs::read("good_bankset_0_0.o").unwrap(),
		&data_0_0
	);
	assert_eq!(
		&std::fs::read("good_bankset_0_1.o").unwrap(),
		&data_0_1
	);
	assert_eq!(
		&std::fs::read("good_bankset_0_2.o").unwrap(),
		&data_0_2
	);
	assert_eq!(
		&std::fs::read("good_bankset_0_3.o").unwrap(),
		&data_0_3
	);


	assert_eq!(
		&std::fs::read("good_bankset_1_0.o").unwrap(),
		&data_1_0
	);
	assert_eq!(
		&std::fs::read("good_bankset_1_1.o").unwrap(),
		&data_1_1
	);
	assert_eq!(
		&std::fs::read("good_bankset_1_2.o").unwrap(),
		&data_1_2
	);
	assert_eq!(
		&std::fs::read("good_bankset_1_3.o").unwrap(),
		&data_1_3
	);
}